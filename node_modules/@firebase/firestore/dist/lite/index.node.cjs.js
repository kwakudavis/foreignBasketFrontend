...
var version$1 = "3.0.3-202181503543";
/**
 * @license
...
var version = "9.0.3-202181503543";
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
var EmptyCredentialsProvider = /** @class */ (function () {
    ...
    EmptyCredentialsProvider.prototype.start = function (asyncQueue, changeListener) {
        // Fire with initial user.
        asyncQueue.enqueueRetryable(function () { return changeListener(User.UNAUTHENTICATED); });
    };
    EmptyCredentialsProvider.prototype.shutdown = function () { };
...
var EmulatorCredentialsProvider = /** @class */ (function () {
    ...
    EmulatorCredentialsProvider.prototype.start = function (asyncQueue, changeListener) {
        var _this = this;
        this.changeListener = changeListener;
        // Fire with initial user.
        asyncQueue.enqueueRetryable(function () { return changeListener(_this.token.user); });
    };
    EmulatorCredentialsProvider.prototype.shutdown = function () {
        this.changeListener = null;
    };
    return EmulatorCredentialsProvider;
}());
/** Credential provider for the Lite SDK. */
var LiteCredentialsProvider = /** @class */ (function () {
    function LiteCredentialsProvider(authProvider) {
        var _this = this;
        this.auth = null;
    ...
    LiteCredentialsProvider.prototype.getToken = function () {
        var _this = this;
        if (!this.auth) {
            return Promise.resolve(null);
        }
        return this.auth.getToken().then(function (tokenData) {
            if (tokenData) {
                hardAssert(typeof tokenData.accessToken === 'string');
                return new OAuthToken(tokenData.accessToken, new User(_this.auth.getUid()));
            }
            else {
                return null;
            }
    ...
    LiteCredentialsProvider.prototype.invalidateToken = function () { };
    LiteCredentialsProvider.prototype.start = function (asyncQueue, changeListener) { };
    LiteCredentialsProvider.prototype.shutdown = function () { };
    return LiteCredentialsProvider;
}());
/*
...
var FirstPartyCredentialsProvider = /** @class */ (function () {
    ...
    FirstPartyCredentialsProvider.prototype.start = function (asyncQueue, changeListener) {
        // Fire with initial uid.
        asyncQueue.enqueueRetryable(function () { return changeListener(User.FIRST_PARTY); });
    };
    FirstPartyCredentialsProvider.prototype.shutdown = function () { };
...
var Firestore = /** @class */ (function () {
    /** @hideconstructor */
    function Firestore(databaseIdOrApp, _credentials) {
    ...
    Firestore.prototype._setSettings = function (settings) {
    ...
    Firestore.prototype._freezeSettings = function () {
        this._settingsFrozen = true;
        return this._settings;
    };
    Firestore.prototype._delete = function () {
    ...
    Firestore.prototype.toJSON = function () {
        return {
            app: this._app,
...
function registerFirestore() {
    ...
    app._registerComponent(new component.Component('firestore/lite', function (container, _c) {
        ...
        var firestoreInstance = new Firestore(app, new LiteCredentialsProvider(container.getProvider('auth-internal')));
        if (settings) {
