...
/** Extracts the backend's type order for the provided value. */ function $t(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Vt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : g();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ft(t, n) {
    ...
    switch (e) {
      ...
      case 9 /* ArrayValue */ :
        return pt(t.arrayValue.values || [], n.arrayValue.values || [], Ft);
...
function qt(t, n) {
    ...
    switch (e) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, n) {
            const e = mt(Pt(t.latitude), Pt(n.latitude));
            if (0 !== e) return e;
            return mt(Pt(t.longitude), Pt(n.longitude));
...
function xt(t, n) {
    ...
    const e = At(t), r = At(n), s = mt(e.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function kt(t) {
    ...
    if (t.arrayValue) {
        ...
        for (let e = 0; e < (t.arrayValue.values || []).length; ++e) n.arrayValue.values[e] = kt(t.arrayValue.values[e]);
        return n;
    }
 ...
 */ class Mt {
     ...
     */    set(t, n) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = kt(n);
    }
    /**
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, s) => {
            ...
            t ? e[s.lastSegment()] = kt(t) : r.push(s.lastSegment());
        }));
 ...
 */ class Bt {
     ...
     */    static newInvalidDocument(t) {
        return new Bt(t, 0 /* INVALID */ , _t.min(), Mt.empty(), 0 /* SYNCED */);
    }
    /**
...
class Wt extends class {} {
     ...
     */    static create(t, n, e) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.R(t, n, e) : new Gt(t, n, e) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Jt(t, e) : "in" /* IN */ === n ? new Zt(t, e) : "not-in" /* NOT_IN */ === n ? new Xt(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new tn(t, e) : new Wt(t, n, e);
    }
    static R(t, n, e) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== n && this.V(qt(n, this.value)) : null !== n && $t(this.value) === $t(n) && this.V(qt(n, this.value));
 ...
 */ function ln(t) {
    ...
    if (null === n.D) {
        ...
        t.isKeyField() || n.D.push(new en(t)), n.D.push(new en(Z.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function fn(t) {
    ...
    if (!n.$) if ("F" /* First */ === n.limitType) n.$ = zt(n.path, n.collectionGroup, ln(n), n.filters, n.limit, n.startAt, n.endAt); else {
        ...
        n.$ = zt(n.path, n.collectionGroup, t, n.filters, n.limit, e, r);
    }
    return n.$;
}
...
function ee(t) {
    ...
    if (!ne.has(t)) {
        ...
        new G(n, e, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = Yn(t._databaseId), u = function(t, n, e) {
            return new Jn(t, n, e);
        }(t._credentials, i, o);
        ne.set(t, u);
    }
 ...
 */ function ue(t, n, e, r = {}) {
    var s;
    const i = (t = st(t, se))._getSettings();
 ...
 * terminated.
 */ function ce(t) {
    return t = st(t, se), n(t.app, "firestore/lite"), t._delete();
}
...
function fe(t, n, ...e) {
    if (t = h(t), tt("collection", "path", n), t instanceof se) {
 ...
 */ function de(t, n) {
    if (t = st(t, se), tt("collectionGroup", "collection id", n), n.indexOf("/") >= 0) throw new U(A, `Invalid collection ID '${n}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new he(t, 
    /* converter= */ null, 
    /**
...
function we(t, n, ...e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = wt.A()), tt("doc", "path", n), t instanceof se) {
        const r = K.fromString(n, ...e);
 ...
 * Firestore database.
 */ function me(t, n) {
    return t = h(t), n = h(n), (t instanceof ae || t instanceof le) && (n instanceof ae || n instanceof le) && (t.firestore === n.firestore && t.path === n.path && t.converter === n.converter);
}
 ...
 * Firestore database.
 */ function pe(t, n) {
    return t = h(t), n = h(n), t instanceof he && n instanceof he && (t.firestore === n.firestore && dn(t._query, n._query) && t.converter === n.converter);
}
...
/** The result of parsing document data (e.g. for a setData call). */ class Ie {
    ...
    toMutation(t, n) {
        return null !== this.fieldMask ? new Tn(t, this.data, this.fieldMask, n, this.fieldTransforms) : new In(t, this.data, n, this.fieldTransforms);
    }
}
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Te {
    ...
    toMutation(t, n) {
        return new Tn(t, this.data, this.fieldMask, n, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Pe {
    ...
    /** Returns a new context with the specified settings overwritten. */    tt(t) {
        return new Pe(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.S, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    nt(t) {
        var n;
    ...
    ot(t) {
        return We(t, this.settings.methodName, this.settings.ut || !1, this.path, this.settings.ct);
    }
    ...
    rt(t) {
        ...
        if (Ae(this.X) && Ee.test(t)) throw this.ot('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Re {
    constructor(t, n, e) {
        this.databaseId = t, this.ignoreUndefinedProperties = n, this.S = e || Yn(t);
    }
...
/** Parse update data from a list of field/value arguments. */ function Ce(t, n, e, r, s, i) {
    const o = t.at(1 /* Update */ , n, e), u = [ Be(n, r, e) ], c = [ s ];
    ...
    for (let t = u.length - 1; t >= 0; --t) if (!Ge(a, u[t])) {
        const n = u[t];
        let e = c[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function Le(t, n, e, r = !1) {
    return Ue(e, t.at(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , n));
}
 ...
 */
    return function(t, n) {
        ...
        if (!Ae(n.X)) throw n.ot(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, n), null;
    ...
    return function(t, n) {
        ...
        if ("number" == typeof t) return wn(n.S, t);
        ...
        if (t instanceof ge) return {
            bytesValue: $n(n.S, t._byteString)
        };
        if (t instanceof ae) {
 ...
 */ function Be(t, n, e) {
    ...
    // FieldPath.
    n = h(n)) instanceof ye) return n._internalPath;
 ...
 */ function Je(t, n) {
    return t = h(t), n = h(n), t instanceof He && n instanceof He ? t._firestore === n._firestore && t._key.isEqual(n._key) && (null === t._document ? null === n._document : t._document.isEqual(n._document)) && t._converter === n._converter : t instanceof Ke && n instanceof Ke && (pe(t.query, n.query) && pt(t.docs, n.docs, Je));
}
...
/** Helper function to create a bound from a document or fields */ function wr(t, n, e, r) {
    if (e[0] = h(e[0]), e[0] instanceof He) return function(t, n, e, r, s) {
        ...
        // results.
            ...
            if (Vt(t)) throw new U(A, 'Invalid query. You are trying to start or end a query using a document for which the field "' + e.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, n, e, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!hn(t) && -1 !== c.indexOf("/")) throw new U(A, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
...
function mr(t, n, e) {
    if ("string" == typeof (e = h(e))) {
        ...
        if (!hn(n) && -1 !== e.indexOf("/")) throw new U(A, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);
...
class xr {
    constructor(t, n, e, r) {
        ...
        this.Et = 5, this.It = new Kn(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Tt() {
        this.It.W((async () => {
            const t = new qr(this.datastore), n = this.At(t);
            n && n.then((n => {
...
class Ur {
    ...
    update(t, n, e, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (n = h(n)) || n instanceof ye ? Ce(this._dataReader, "Transaction.update", s._key, n, e, r) : Oe(this._dataReader, "Transaction.update", s._key, n), 
...
}), "PUBLIC" /* PUBLIC */)), r("firestore-lite", "3.0.3-202181503543", "node");
