 ...
 * limitations under the License.
 */
var m = "9.0.3-202181503543", y = new f("@firebase/firestore");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var I = "ok", A = "cancelled", V = "unknown", D = "invalid-argument", k = "deadline-exceeded", P = "not-found", N = "permission-denied", F = "unauthenticated", O = "resource-exhausted", q = "failed-precondition", j = "aborted", L = "out-of-range", R = "unimplemented", U = "internal", x = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
    ...
    return t.prototype.getToken = function() {
        ...
        return this.auth ? this.auth.getToken().then((function(e) {
            return e ? (T("string" == typeof e.accessToken), new M(e.accessToken, new d(t.auth.getUid()))) : null;
...
}(X), J = /^[_a-zA-Z][_a-zA-Z0-9]*$/, Z = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
 ...
 */ function nt(t) {
    if (!tt.isDocumentKey(t)) throw new B(D, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function rt(t) {
    if (tt.isDocumentKey(t)) throw new B(D, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function it(t) {
 ...
 */
function ht(t) {
    if (void 0 === t) return w("RPC_ERROR", "HTTP error has no status"), V;
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? I : t >= 400 && t < 500 ? q : t >= 500 && t < 600 ? U : V;
    }
}
 ...
 */ (ft = ct || (ct = {}))[ft.OK = 0] = "OK", ft[ft.CANCELLED = 1] = "CANCELLED", 
...
var pt = /** @class */ function(r) {
     ...
     * HTTP).
     */
    return t(i, r), i.prototype.T = function(t, e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    throw a = n.sent(), new B(ht(a.status), "Request failed with error: " + a.statusText);

                  case 4:
                    if (!e.ok) throw new B(ht(e.status), "Request failed with error: " + e.statusText);
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ft(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return vt(t.arrayValue.values || [], e.arrayValue.values || [], Ft);
...
function qt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = yt(At(t.latitude), At(e.latitude));
            return 0 !== n ? n : yt(At(t.longitude), At(e.longitude));
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (var a = 0; a < r.length && a < o.length; ++a) {
                var s = yt(r[a], o[a]);
                if (0 !== s) return s;
                var u = qt(n[r[a]], i[o[a]]);
                if (0 !== u) return u;
            }
            return yt(r.length, o.length);
...
function jt(t, e) {
    ...
    var n = It(t), r = It(e), i = yt(n.seconds, r.seconds);
    return 0 !== i ? i : yt(n.nanos, r.nanos);
}
...
/** Creates a deep copy of `source`. */ function Ct(t) {
    ...
    if (t.mapValue) {
        ...
        return _t(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = Ct(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Ct(t.arrayValue.values[r]);
        return n;
    }
 ...
 */ var Mt = /** @class */ function() {
    ...
    t.prototype.set = function(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = Ct(e);
    }, 
    /**
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Ct(t) : i.push(o.lastSegment());
        }));
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , wt.min(), Mt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, Mt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, Mt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
var Ht = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, r) : new Kt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new $t(t, r) : "in" /* IN */ === e ? new Jt(t, r) : "not-in" /* NOT_IN */ === e ? new Zt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new te(t, r) : new n(t, e, r);
    }, n.R = function(t, e, n) {
        return "in" /* IN */ === e ? new Wt(t, n) : new Yt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.V(qt(e, this.value)) : null !== e && Nt(this.value) === Nt(e) && this.V(qt(e, this.value));
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = tt.fromName(r.referenceValue), 
        i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = tt.comparator(t.key, this.key);
        return this.V(e);
    }, n;
}(Ht), Wt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
/** A Filter that implements the array-contains operator. */ var $t = /** @class */ function(e) {
    function n(t, n) {
...
}, ne = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function re(t, e) {
 ...
 */ function fe(t) {
    ...
    if (null === e.D) {
        ...
        n.isKeyField() || e.D.push(new ne(n)), e.D.push(new ne(Z.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function le(t) {
    var e = E(t);
    if (!e.$) if ("F" /* First */ === e.limitType) e.$ = zt(e.path, e.collectionGroup, fe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = fe(e); r < i.length; r++) {
            var o = i[r], a = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new ne(o.field, a));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new ee(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new ee(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.$ = zt(e.path, e.collectionGroup, n, e.filters, e.limit, s, u);
    }
    return e.$;
}
...
}(), be = function() {}, _e = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function Ne(t) {
    return T(!!t), wt.fromTimestamp(function(t) {
        var e = It(t);
        return new gt(e.seconds, e.nanos);
    }(t));
}
...
function qe(t, e) {
    ...
    return new tt((T((n = r).length > 4 && "documents" === n.get(4)), n.popFirst(5)));
}
 ...
 */ var ze = /** @class */ function() {
    ...
    t.prototype.W = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.j + this.G()), r = Math.max(0, Date.now() - this.M), i = Math.max(0, n - r);
    ...
    return t(n, e), n.prototype.J = function() {
        if (this.K) throw new B(q, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.l = function(t, e, n) {
        ...
        return this.J(), this.credentials.getToken().then((function(i) {
            ...
            throw "FirebaseError" === t.name ? (t.code === F && r.credentials.invalidateToken(), 
            t) : new B(V, t.toString());
        }));
    }, 
                ...
                return a = n.sent(), s = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = qe(t, e.found.name), r = Ne(e.found.updateTime), i = new Mt({
                                mapValue: {
                            ...
                            var n = qe(t, e.missing), r = Ne(e.readTime);
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                }(e.S, le(r)), [ 4 /*yield*/ , e.v("RunQuery", i.parent, {
              ...
              case 1:
                return [ 2 /*return*/ , n.sent().filter((function(t) {
                    ...
                    return function(t, e, n) {
                        var r = qe(t, e.name), i = Ne(e.updateTime), o = new Mt({
                            mapValue: {
                                fields: e.fields
                            }
                        }), a = Gt.newFoundDocument(r, i, o);
                        return a;
                    }(e.S, t.document);
                })) ];
            }
 ...
 */ function $e(t) {
    if (t._terminated) throw new B(q, "The client has already been terminated.");
    if (!Xe.has(t)) {
        ...
        new W(i, o, a, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), n = Qe(t._databaseId), r = function(t, e, n) {
            return new He(t, e, n);
        }(t._credentials, e, n);
        Xe.set(t, r);
    }
 ...
 */ var Je = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof Y ? this._databaseId = t : (this._app = t, 
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new B(q, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new B(q, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Je(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new G;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */ function tn(t, e) {
    ...
    if (n.isInitialized()) throw new B(q, "Firestore can only be initialized once per app.");
    return n.initialize({
        options: e
    });
}
 ...
 */ function nn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, s = d.MOCK_USER; else {
            ...
            if (!u) throw new B(D, "mockUserToken must contain 'sub' or 'user_id' field!");
            s = new d(u);
        }
        t._credentials = new Q(new M(a, s));
    }
}
 ...
 * terminated.
 */ function rn(t) {
    return t = ot(t, Ze), u(t.app, "firestore/lite"), t._delete()
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var on = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, new oe(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function un(t, e) {
    ...
    if (t = h(t), et("collection", "path", e), t instanceof Ze) {
        var o = $.fromString.apply($, r([ e ], n));
        return rt(o), new sn(t, /* converter= */ null, o);
    }
    if (!(t instanceof on || t instanceof sn)) throw new B(D, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child($.fromString.apply($, r([ e ], n)));
    return rt(a), new sn(t.firestore, 
    /* converter= */ null, a);
}
 ...
 */ function cn(t, e) {
    if (t = ot(t, Ze), et("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(D, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new an(t, 
    /* converter= */ null, 
    /**
...
function fn(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = mt.A()), et("doc", "path", e), t instanceof Ze) {
        var o = $.fromString.apply($, r([ e ], n));
        return nt(o), new on(t, 
        /* converter= */ null, new tt(o));
    }
    if (!(t instanceof on || t instanceof sn)) throw new B(D, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child($.fromString.apply($, r([ e ], n)));
    return nt(a), new on(t.firestore, t instanceof sn ? t.converter : null, new tt(a));
}
 ...
 * Firestore database.
 */ function ln(t, e) {
    return t = h(t), e = h(e), (t instanceof on || t instanceof sn) && (e instanceof on || e instanceof sn) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function hn(t, e) {
    return t = h(t), e = h(e), t instanceof an && e instanceof an && t.firestore === e.firestore && function(t, e) {
        return function(t, e) {
            if (t.limit !== e.limit) return !1;
            if (t.orderBy.length !== e.orderBy.length) return !1;
            for (var n = 0; n < t.orderBy.length; n++) if (!re(t.orderBy[n], e.orderBy[n])) return !1;
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Se(t, this.data, this.fieldMask, e, this.fieldTransforms) : new _e(t, this.data, e, this.fieldTransforms);
    }, t;
}(), bn = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Sn = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (_n(this.X) && gn.test(t)) throw this.ot('Document fields cannot begin and end with "__"');
    }, t;
}(), Tn = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.S = n || Qe(t)
 ...
 */ function En(t) {
    ...
    return new Tn(t._databaseId, !!e.ignoreUndefinedProperties, n);
}
...
var Dn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new ge(t.path, new de);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(yn), kn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new ve(t.S, he(t.S, this.lt));
...
/** Parse update data from a list of field/value arguments. */ function On(t, e, n, r, i, o) {
    var a = t.at(1 /* Update */ , e, n), s = [ xn(e, r, n) ], u = [ i ];
    ...
    for (var f = [], l = Mt.empty(), p = s.length - 1; p >= 0; --p) if (!Gn(f, s[p])) {
        var d = s[p], m = u[p];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        m = h(m);
    ...
    var g = new St(f);
    return new bn(l, g, a.fieldTransforms);
}
 ...
 */ function qn(t, e, n, r) {
    return void 0 === r && (r = !1), jn(n, t.at(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function jn(t, e) {
    ...
    // from firestore-exp.
    t = h(t))) return Un("Unsupported field value:", e, t), Ln(t, e);
    if (t instanceof yn) 
    ...
    return function(t, e) {
        ...
        if (!_n(e.X)) throw e.ot(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return he(e.S, t);
        ...
        if (t instanceof gt) {
            ...
            var r = new gt(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: De(e.S, r)
            };
        }
        ...
        if (t instanceof mn) return {
            bytesValue: ke(e.S, t._byteString)
        };
        if (t instanceof on) {
        ...
        throw e.ot("Unsupported field value: " + it(t));
    }(t, e);
}
...
function Rn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof gt || t instanceof vn || t instanceof mn || t instanceof on || t instanceof yn);
}
 ...
 */ function xn(t, e, n) {
    ...
    if ("string" == typeof e) return Cn(t, e);
    throw Mn("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Cn(t, e, n) {
    if (e.search(Bn) >= 0) throw Mn("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (pn.bind.apply(pn, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw Mn("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new zn(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 */
function Kn(t, e) {
    return t = h(t), e = h(e), t instanceof Qn && e instanceof Qn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Hn && e instanceof Hn && hn(t.query, e.query) && vt(t.docs, e.docs, Kn)
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
}
...
function Wn(t, e) {
    return "string" == typeof e ? Cn(t, e) : e instanceof pn ? e._internalPath : e._delegate._internalPath;
}
 ...
 * @returns The created {@link Query}.
 */ function nr(t) {
    return at("limit", t), new er("limit", t, "F" /* First */)
    /**
...
function rr(t) {
    return at("limitToLast", t), new er("limitToLast", t, "L" /* Last */);
}
...
function or() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new ir("startAt", t, /*before=*/ !0);
}
...
function ur() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new sr("endBefore", t, /*before=*/ !0);
}

function cr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new sr("endAt", t, /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function fr(t, e, n, r) {
    if (n[0] = h(n[0]), n[0] instanceof Qn) return function(t, e, n, r, i) {
        if (!r) throw new B(P, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var s = [], u = 0; u < i.length; u++) {
            ...
            if (a[u].field.isKeyField()) {
                ...
                if (!ce(t) && -1 !== c.indexOf("/")) throw new B(D, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child($.fromString(c));
                if (!tt.isDocumentKey(f)) throw new B(D, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var l = new tt(f);
                s.push(Lt(e, l));
            } else {
                var h = qn(n, r, c);
...
function lr(t, e, n) {
    if ("string" == typeof (n = h(n))) {
        ...
        if (!ce(e) && -1 !== n.indexOf("/")) throw new B(D, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child($.fromString(n));
        if (!tt.isDocumentKey(r)) throw new B(D, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Lt(t, new tt(r));
    }
    if (n instanceof on) return Lt(t, n._key);
    throw new B(D, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + it(n) + ".");
}
...
var mr = /** @class */ function(e) {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return _t(t.fields, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new vn(At(t.latitude), At(t.longitude));
        ...
        var n = $.fromString(t);
        T(Ge(n));
        var r = new Y(n.get(1), n.get(3)), i = new tt(n.popFirst(5));
        return r.isEqual(e) || 
 ...
 * document contents.
 */ function yr(t) {
    var e = $e((t = ot(t, on)).firestore), n = new mr(t.firestore);
 ...
 */ function vr(t) {
    !function(t) {
        if (ae(t) && 0 === t.explicitOrderBy.length) throw new B(R, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = ot(t, an))._query);
    var e = $e(t.firestore), n = new mr(t.firestore);
    return Ye(e, t._query).then((function(e) {
        var r = e.map((function(e) {
            return new zn(t.firestore, n, e.key, e, t.converter);
        }));
        return ae(t._query) && 
...
function gr(t, e, n) {
    var r = dr((t = ot(t, on)).converter, e, n), i = In(En(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return Ke($e(t.firestore), [ i.toMutation(t._key, we.none()) ]);
}

function wr(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    var o, a = En((t = ot(t, on)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = h(e)) || e instanceof pn ? On(a, "updateDoc", t._key, e, n, r) : Fn(a, "updateDoc", t._key, e), 
    Ke($e(t.firestore), [ o.toMutation(t._key, we.exists(!0)) ]);
}
 ...
 */ function br(t) {
    return Ke($e((t = ot(t, on)).firestore), [ new Te(t._key, we.none()) ]);
}
 ...
 */ function _r(t, e) {
    var n = fn(t = ot(t, sn)), r = dr(t.converter, e), i = In(En(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return Ke($e(t.firestore), [ i.toMutation(n._key, we.exists(!1)) ]).then((function() {
        return n;
    }));
}
 ...
 */ var Vr = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Dr(t, this._firestore), i = dr(r.converter, e, n), o = In(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, we.none())), this;
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = h(e)) || e instanceof pn ? On(this._dataReader, "WriteBatch.update", a._key, e, n, r) : Fn(this._dataReader, "WriteBatch.update", a._key, e), 
        this._mutations.push(o.toMutation(a._key, we.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new Te(e._key, we.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new B(q, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 */ var Pr = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
                ...
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = tt.fromPath(n);
                        e.mutations.push(new Ee(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new B(j, "Document version changed between two reads.");
    ...
    function t(t, e, n, r) {
        ...
        this.Et = 5, this.It = new ze(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.It.W((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Pr(this.datastore), (e = this.At(t)) && e.then((function(e) {
 ...
 */ var Or = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new C, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new B(A, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.It = new ze(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Lt((function() {
            return e.Dt && e.qt ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
                ...
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    // Failure will be handled by AsyncQueue
                                        return g("AsyncQueue", "Operation failed with retryable error: " + t), 
                    [ 3 /*break*/ , 4 ];
 ...
 */
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Dr(t, this._firestore), r = new mr(this._firestore);
        ...
        var r = Dr(t, this._firestore), i = dr(r.converter, e, n), o = In(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = h(e)) || e instanceof pn ? On(this._dataReader, "Transaction.update", a._key, e, n, r) : Fn(this._dataReader, "Transaction.update", a._key, e), 
 ...
 */
function Lr(t, e) {
    var n = $e(t = ot(t, Ze)), r = new C;
    return new Nr(new qr, n, (function(n) {
        return e(new jr(t, n));
    }), r).run(), r.promise
    /**
 * Firestore Lite
...
}), "PUBLIC" /* PUBLIC */)), a("firestore-lite", "3.0.3-202181503543", "node");
