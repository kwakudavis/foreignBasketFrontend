...
import { getUA as l, isSafari as d, isMobileCordova as p, isReactNative as y, isElectron as v, isIE as m, isUWP as g, isBrowserExtension as w, getModularInstance as b, createMockUserToken as I, deepEqual as T } from "@firebase/util";

import { XhrIo as E, EventType as S, ErrorCode as N, createWebChannelTransport as _, getStatEventTarget as D, FetchXmlHttpFactory as A, WebChannel as k, Event as C, Stat as x } from "@firebase/webchannel-wrapper";
 ...
 * limitations under the License.
 */
var R = "9.0.3-202181503543", O = new h("@firebase/firestore");
...
function M(t) {
    ...
    if (O.logLevel <= f.DEBUG) {
        var i = n.map(U);
        O.debug.apply(O, e([ "Firestore (" + R + "): " + t ], i));
    }
}

function V(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (O.logLevel <= f.ERROR) {
        var i = n.map(U);
        O.error.apply(O, e([ "Firestore (" + R + "): " + t ], i));
    }
}
 ...
 */ function q(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (O.logLevel <= f.WARN) {
        var i = n.map(U);
        O.warn.apply(O, e([ "Firestore (" + R + "): " + t ], i));
    }
}
 ...
 */ var G = {
    ...
    function t(t) {
        ...
        this.currentUser = L.UNAUTHENTICATED, 
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), a.resolve(), a = new H, t.enqueueRetryable((function() {
        ...
        var u = function() {
            ...
            M("FirebaseCredentialsProvider", "Auth detected"), i.auth = t, i.auth.addAuthTokenListener(i.o), 
            u();
        };
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                M("FirebaseCredentialsProvider", "Auth not yet detected"), a.resolve(), a = new H);
            }
        }), 0), u();
        ...
        // request is outstanding.
            ...
            return t.i !== e ? (M("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (K("string" == typeof n.accessToken), new W(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.u = function() {
        ...
        return K(null === t || "string" == typeof t), new L(t);
    }, t;
}(), $ = /** @class */ function() {
    function t(t, e, n) {
        this.h = t, this.l = e, this.m = n, this.type = "FirstParty", this.user = L.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new $(this.h, this.l, this.m));
    ...
    return t.prototype.g = function(t) {
...
var nt = /** @class */ function() {
    ...
    return t.I = function() {
        ...
        ; n.length < 20; ) for (var r = et(40), i = 0; i < r.length; ++i) 
 ...
 */ var ft = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new Q(G.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
...
}(ft), dt = /^[_a-zA-Z][_a-zA-Z0-9]*$/, pt = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new Q(G.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var a = t[i];
            if ("\\" === a) {
                if (i + 1 === t.length) throw new Q(G.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new Q(G.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
            } else "`" === a ? (s = !s, i++) : "." !== a || s ? (r += a, i++) : (o(), i++);
        }
        if (o(), s) throw new Q(G.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
}(ft), yt = /** @class */ function() {
    function t(t) {
        this.fields = t, 
        // TODO(dimond): validation of FieldMask
        // Sort the field mask to support `FieldMask.isEqual()` and assert below.
        t.sort(pt.comparator)
        /**
    ...
    return t.prototype.covers = function(t) {
        ...
        return it(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}();
...
/** Returns whether the value represents -0. */ function _t(t) {
 ...
 */ function Dt(t) {
    return "number" == typeof t && Number.isInteger(t) && !_t(t) && t <= Number.MAX_SAFE_INTEGER && t >= Number.MIN_SAFE_INTEGER;
}
...
/** Extracts the backend's type order for the provided value. */ function kt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Tt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : B();
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                var n = bt(t.doubleValue), r = bt(e.doubleValue);
                return n === r ? _t(n) === _t(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return it(t.arrayValue.values || [], e.arrayValue.values || [], Ct);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (ut(n) !== ut(r)) return !1;
...
function Lt(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            var n = bt(t.integerValue || t.doubleValue), r = bt(e.integerValue || e.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = rt(bt(t.latitude), bt(e.latitude));
            return 0 !== n ? n : rt(bt(t.longitude), bt(e.longitude));
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (var s = 0; s < r.length && s < o.length; ++s) {
                var a = rt(r[s], o[s]);
                if (0 !== a) return a;
                var u = Lt(n[r[s]], i[o[s]]);
                if (0 !== u) return u;
            }
            return rt(r.length, o.length);
...
function Rt(t, e) {
    ...
    var n = wt(t), r = wt(e), i = rt(n.seconds, r.seconds);
    return 0 !== i ? i : rt(n.nanos, r.nanos);
}
...
/** Creates a deep copy of `source`. */ function Kt(t) {
    ...
    if (t.arrayValue) {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Kt(t.arrayValue.values[r]);
        return n;
    }
 ...
 */ var jt = /** @class */ function() {
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Kt(t) : i.push(o.lastSegment());
        }));
...
var Gt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , at.min(), jt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, jt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, jt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function Wt(t) {
    ...
    if (null === e.A) {
        ...
        n += ae(e.startAt)), e.endAt && (n += "|ub:", n += ae(e.endAt)), e.A = n;
    }
    return e.A;
}
...
function Yt(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!ce(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], 
    i.op !== o.op || !i.field.isEqual(o.field) || !Ct(i.value, o.value)) return !1;
    var i, o;
    return t.collectionGroup === e.collectionGroup && !!t.path.isEqual(e.path) && !!fe(t.startAt, e.startAt) && fe(t.endAt, e.endAt);
}
...
var Xt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, r) : new $t(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ne(t, r) : "in" /* IN */ === e ? new re(t, r) : "not-in" /* NOT_IN */ === e ? new ie(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new oe(t, r) : new n(t, e, r);
    }, n.R = function(t, e, n) {
        return "in" /* IN */ === e ? new Zt(t, n) : new te(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.P(Lt(e, this.value)) : null !== e && kt(this.value) === kt(e) && this.P(Lt(e, this.value));
...
var $t = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = ee("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Xt), te = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = ee("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function ee(t, e) {
    var n;
...
/** A Filter that implements the array-contains operator. */ var ne = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Vt(e) && xt(e.arrayValue, this.value);
    }, n;
}(Xt), re = /** @class */ function(e) {
    function n(t, n) {
...
/** A Filter that implements the IN operator. */ function ae(t) {
    // TODO(b/29183165): Make this collision robust.
...
/** Creates a new Query instance with the options provided. */ function de(t, e, n, r, i, o, s, a) {
    return new le(t, e, n, r, i, o, s, a);
}
 ...
 */ function Ie(t) {
    var e = z(t);
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Ht(e.path, e.collectionGroup, be(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = be(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new ue(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new se(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new se(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.S = Ht(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.S;
}
...
function Ee(t, e) {
    return Yt(Ie(t), Ie(e)) && t.limitType === e.limitType;
}
...
function Ne(t) {
    return "Query(target=" + function(t) {
        ...
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + ae(t.startAt)), t.endAt && (e += ", endAt: " + ae(t.endAt)), 
        "Target(" + e + ")";
    }(Ie(t)) + "; limitType=" + t.limitType + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function _e(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !he(t.startAt, be(t), e)) && (!t.endAt || !he(t.endAt, be(t), e));
    }(t, e);
}

function De(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = be(t); i < o.length; i++) {
            var s = o[i], a = Ae(s, e, n);
            if (0 !== a) return a;
 ...
 */ function Re(t, e, n) {
    ...
    }(n, e) : t instanceof Me ? Ve(t, e) : t instanceof qe ? Ue(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Pe(t, e), r = Ke(n) + Ke(t.C);
        return Mt(n) && Mt(t.C) ? Ce(r) : ke(t.N, r);
    }(t, e);
}
 ...
 */ function Oe(t, e, n) {
    ...
    // applications.
    return t instanceof Me ? Ve(t, e) : t instanceof qe ? Ue(t, e) : n;
}
 ...
 */ function Pe(t, e) {
    return t instanceof Be ? Mt(n = e) || function(t) {
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var ze = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function He(t, e) {
 ...
 */ function Ye(t, e, n) {
    t instanceof tn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = rn(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof en ? function(t, e, n) {
        if (He(t.precondition, e)) {
            var r = rn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(nn(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Je(t, e, n) {
    t instanceof tn ? function(t, e, n) {
        if (He(t.precondition, e)) {
            var r = t.value.clone(), i = on(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Ze(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof en ? function(t, e, n) {
        if (He(t.precondition, e)) {
            var r = on(t.fieldTransforms, n, e), i = e.data;
            i.setAll(nn(t)), i.setAll(r), e.convertToFoundDocument(Ze(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        He(t.precondition, e) && 
 ...
 */ function Xe(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), a = Pe(o.transform, s || null);
        null != a && (null == n && (n = jt.empty()), n.set(o.field, a));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && it(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Me && e instanceof Me || t instanceof qe && e instanceof qe ? it(t.elements, e.elements, Ct) : t instanceof Be && e instanceof Be ? Ct(t.C, e.C) : t instanceof Fe && e instanceof Fe;
 ...
 */ function on(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, Re(a, u, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var sn, an, un = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function ln(t) {
    ...
    return V("GRPC error has no .code"), G.UNKNOWN;
    switch (t) {
      case sn.OK:
        return G.OK;
 ...
 *     Code.UNKNOWN.
 */ (an = sn || (sn = {}))[an.OK = 0] = "OK", an[an.CANCELLED = 1] = "CANCELLED", 
an[an.UNKNOWN = 2] = "UNKNOWN", an[an.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
an[an.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", an[an.NOT_FOUND = 5] = "NOT_FOUND", 
an[an.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", an[an.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
an[an.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", an[an.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
an[an.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", an[an.ABORTED = 10] = "ABORTED", 
an[an.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", an[an.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
an[an.INTERNAL = 13] = "INTERNAL", an[an.UNAVAILABLE = 14] = "UNAVAILABLE", an[an.DATA_LOSS = 15] = "DATA_LOSS";
...
var dn = /** @class */ function() {
    function t(t, e) {
        this.comparator = t, this.root = e || yn.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, yn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, yn.BLACK, null, null));
    }, 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
yn.EMPTY = null, yn.RED = !0, yn.BLACK = !1, 
// end LLRBEmptyNode
yn.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
}(), gn = new dn(At.comparator);

function wn() {
    return gn;
}

var bn = new dn(At.comparator);

function In() {
    return bn;
}

var Tn = new dn(At.comparator);

function En() {
    return Tn;
}

var Sn = new vn(At.comparator);
 ...
 */ var An = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, kn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(at.min(), r, Dn(), wn(), Nn());
    }, t;
}(), kn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(mt.EMPTY_BYTE_STRING, n, Nn(), Nn(), Nn());
    }, t;
}(), Cn = function(
...
/**
     ...
     */
r) {
    this.k = t, this.removedTargetIds = e, this.key = n, this.$ = r;
}, xn = function(t, e) {
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = mt.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.L = mt.EMPTY_BYTE_STRING, this.B = !1, 
        /**
    ...
    t.prototype.W = function() {
        var t = Nn(), e = Nn(), n = Nn();
        return this.M.forEach((function(r, i) {
            switch (i) {
              case 0 /* Added */ :
                t = t.add(r);
                break;
    ...
    return t.prototype.rt = function(t) {
        for (var e = 0, n = t.k; e < n.length; e++) {
            var r = n[e];
            t.$ && t.$.isFoundDocument() ? this.ot(r, t.$) : this.at(r, t.key, t.$);
        }
    ...
    /** Processes and adds the WatchTargetChange to the current set of changes. */ t.prototype.ct = function(t) {
        var e = this;
        this.forEachTarget(t, (function(n) {
            var r = e.ut(n);
            switch (t.state) {
              case 0 /* NoChange */ :
                e.ht(n) && r.j(t.resumeToken);
                break;
              ...
              case 2 /* Removed */ :
                ...
                // We need to decrement the number of pending acks needed from watch
                // for this targetId.
                r.X(), r.q || e.removeTarget(n);
                break;

              case 3 /* Current */ :
                e.ht(n) && (r.Z(), r.j(t.resumeToken));
                break;
    ...
    t.prototype.forEachTarget = function(t, e) {
        var n = this;
        t.targetIds.length > 0 ? t.targetIds.forEach(e) : this.et.forEach((function(t, r) {
            n.ht(r) && e(r);
        }));
    }, 
    /**
    ...
    t.prototype.ft = function(t) {
        ...
        if (r) {
            ...
            if (Jt(i)) if (0 === n) {
                ...
                // queries.
                var o = new At(i.path);
                this.at(e, o, Gt.newNoDocument(o, at.min()));
            } else K(1 === n); else this.wt(e) !== n && (
    ...
    t.prototype._t = function(t) {
        ...
        this.et.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Jt(o.target)) {
                    ...
                    null !== e.nt.get(s) || e.gt(i, s) || e.at(i, s, Gt.newNoDocument(s, t));
                }
                r.K && (n.set(i, r.W()), r.G());
            }
        }));
        ...
        var i = new An(t, n, this.it, this.nt, r);
        return this.nt = wn(), this.st = Pn(), this.it = new vn(rt), i;
    }, 
    /**
    ...
    t.prototype.ot = function(t, e) {
        if (this.ht(t)) {
            var n = this.gt(t, e.key) ? 2 /* Modified */ : 0 /* Added */;
     ...
     */
    // Visible for testing.
    t.prototype.at = function(t, e, n) {
        if (this.ht(t)) {
            var r = this.ut(t);
            this.gt(t, e) ? r.H(e, 1 /* Removed */) : 
            // The document may have entered and left the target before we raised a
            // snapshot, so we can just ignore the change.
            r.J(e), this.st = this.st.insert(e, this.yt(e).delete(t)), n && (this.nt = this.nt.insert(e, n));
        }
    ...
    t.prototype.Y = function(t) {
        ...
        var e = this.et.get(t);
        return e || (e = new Rn, this.et.set(t, e)), e;
    }, t.prototype.yt = function(t) {
        var e = this.st.get(t);
        return e || (e = new vn(rt), this.st = this.st.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.lt = function(t) {
        var e = this;
        this.et.set(t, new Rn), this.tt.getRemoteKeysForTarget(t).forEach((function(n) {
            e.at(t, n, /*updatedDocument=*/ null);
        }));
    }, 
    /**
...
function jn(t) {
    return K(!!t), at.fromTimestamp(function(t) {
        var e = wt(t);
        return new st(e.seconds, e.nanos);
    }(t));
}
...
function Yn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? lt.emptyPath() : Xn(e);
}
...
function Zn(t, e, n) {
    var r = Hn(t, e.name), i = jn(e.updateTime), o = new jt({
        mapValue: {
            fields: e.fields
        }
    }), s = Gt.newFoundDocument(r, i, o);
...
function tr(t, e) {
    ...
    if (e instanceof tn) n = {
        update: $n(t, e.key, e.value)
    }; else if (e instanceof un) n = {
        delete: Qn(t, e.key)
    }; else if (e instanceof en) n = {
        update: $n(t, e.key, e.data),
        updateMask: pr(e.fieldMask)
    }; else {
        if (!(e instanceof cn)) return B();
        n = {
            verify: Qn(t, e.key)
        };
    }
...
function er(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Qe.updateTime(jn(t.updateTime)) : void 0 !== t.exists ? Qe.exists(t.exists) : Qe.none();
    }(e.currentDocument) : Qe.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) K("REQUEST_TIME" === e.setToServerValue), n = new Fe; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Me(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new qe(i);
            } else "increment" in e ? n = new Be(t, e.increment) : B();
            var o = pt.fromServerFormat(e.fieldPath);
            return new ze(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Hn(t, e.update.name), o = new jt({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                var e = t.fieldPaths || [];
                return new yt(e.map((function(t) {
                    return pt.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new en(i, o, s, n, r);
        }
        return new tn(i, o, n, r);
    }
    if (e.delete) {
        var a = Hn(t, e.delete);
        return new un(a, n);
...
function rr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Wn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Wn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = sr(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = sr(e.endAt)), n;
}

function ir(t) {
    var e = Yn(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        K(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = or(n.where));
    var a = [];
    n.orderBy && (a = n.orderBy.map((function(t) {
        return function(t) {
            return new ue(fr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var c = null;
    n.startAt && (c = ar(n.startAt));
    var h = null;
    return n.endAt && (h = ar(n.endAt)), de(e, i, a, s, u, "F" /* First */ , c, h);
}

function or(t) {
    return t ? void 0 !== t.unaryFilter ? [ dr(t) ] : void 0 !== t.fieldFilter ? [ lr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return or(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : B() : [];
...
function lr(t) {
    return Xt.create(fr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ function vr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = gr(e)), e = mr(t.get(n), e);
    return gr(e);
}

/** Encodes a single segment of a resource path into the given result */ function mr(t, e) {
 ...
 */ function wr(t) {
    ...
    var e = t.length;
    if (K(e >= 2), 2 === e) return K("" === t.charAt(0) && "" === t.charAt(1)), lt.emptyPath();
...
/**
     ...
     */
Dr.readTimeIndex = "readTimeIndex", Dr.readTimeIndexPath = "readTime", 
/**
     ...
     */
Dr.collectionReadTimeIndex = "collectionReadTimeIndex", Dr.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
kr.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
kr.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ Cr.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Cr.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Cr.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Cr.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ Rr.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Or.store = "bundles", Or.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Pr.store = "namedQueries", Pr.keyPath = "name";

// Visible for testing
var Fr = e(e([], e(e([], e(e([], e(e([], [ Tr.store, Er.store, Sr.store, Dr.store, kr.store, Ir.store, xr.store, Cr.store ]), [ Rr.store ])), [ Ar.store ])), [ Lr.store ])), [ Or.store, Pr.store ]), Mr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Vr = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.Tt = new H, this.transaction.oncomplete = function() {
            n.Tt.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.Tt.reject(new jr(t, e.error)) : n.Tt.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Wr(e.target.error);
            n.Tt.reject(new jr(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
    ...
    }, Object.defineProperty(t.prototype, "It", {
        get: function() {
        ...
        t && this.Tt.reject(t), this.aborted || (M("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
     ...
     */
    function t(e, n, r) {
        this.name = e, this.version = n, this.At = r, 
        // NOTE: According to https://bugs.webkit.org/show_bug.cgi?id=197050, the
        // bug we're checking for should exist in iOS >= 12.2 and < 13, but for
        // whatever reason it's much harder to hit after 12.2 so we only proactively
        // log on 12.2.
        12.2 === t.Rt(l()) && V("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return M("SimpleDb", "Removing database:", t), Qr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.bt = function() {
        ...
        // Check the UA string to find out the browser.
                var e = l(), n = t.Rt(e), r = 0 < n && n < 10, i = t.vt(e), o = 0 < i && i < 4.5;
        // IE 10
    ...
    /** Helper to get a typed SimpleDbStore from a transaction. */ t.St = function(t, e) {
        return t.store(e);
    }, 
    // visible for testing
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new jr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new Q(G.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === n.name ? r(new Q(G.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + n)) : r(new jr(t, n));
                        }, i.onupgradeneeded = function(t) {
                            M("SimpleDb", 'Database "' + n.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            n.At.Ct(e, i.transaction, t.oldVersion, n.version).next((function() {
                  ...
                  case 2:
                    return [ 2 /*return*/ , (this.Nt && (this.db.onversionchange = function(t) {
                        return n.Nt(t);
                    }), this.db) ];
                }
            }));
                    ...
                    n = "readonly" === e, s = 0, a = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , u.Dt(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return u.db = r.sent(), e = Ur.open(u.db, t, n ? "readonly" : "readwrite", i), a = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), qr.reject(t);
                              ...
                              case 4:
                                return h = r.sent(), f = "FirebaseError" !== h.name && s < 3, M("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
    ...
    t.prototype.delete = function() {
        return Qr(this.kt.delete());
    }, t;
}(), jr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, G.UNAVAILABLE, "IndexedDB transaction '" + t + "' failed: " + n) || this).name = "IndexedDbTransactionError", 
        r;
    }
    return t(n, e), n;
}(Q);
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function zr(t) {
 ...
 */ var Gr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return M("SimpleDb", "ADD", this.store.name, t, t), Qr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Qr(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), M("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return M("SimpleDb", "DELETE", this.store.name, t), Qr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return M("SimpleDb", "COUNT", this.store.name), Qr(this.store.count());
        ...
        n.qt = !1;
        var r = this.cursor(n);
        return this.Bt(r, (function(t, e, n) {
            return n.delete();
        }));
    ...
    t.prototype.jt = function(t) {
        var e = this.cursor({});
        return new qr((function(n, r) {
            e.onerror = function(t) {
                var e = Wr(t.target.error);
                r(e);
        ...
        var n = [];
        return new qr((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new Kr(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof qr) {
                        var a = s.catch((function(t) {
                            return o.done(), qr.reject(t);
                        }));
                        n.push(a);
                    }
...
function Wr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new Q("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Hr || (Hr = !0, 
 ...
 */ var Yr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Qt = t, r.currentSequenceNumber = n, r;
    }
    return t(n, e), n;
}(Vr);
 ...
 */ var Xr = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Ye(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Je(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && Je(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        e.applyToLocalView(i), r.isValidDocument() || i.convertToNoDocument(at.min());
        }));
        ...
        return this.batchId === t.batchId && it(this.mutations, t.mutations, (function(t, e) {
            return $e(t, e);
        })) && it(this.baseMutations, t.baseMutations, (function(t, e) {
            return $e(t, e);
        }));
    }, t;
}(), $r = /** @class */ function() {
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = En(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = at.min()), void 0 === o && (o = at.min()), void 0 === s && (s = mt.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function ei(t, e) {
    ...
    if (e.noDocument) {
        var n = At.fromSegments(e.noDocument.path), r = si(e.noDocument.readTime), i = Gt.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = At.fromSegments(e.unknownDocument.path), s = si(e.unknownDocument.version);
        return Gt.newUnknownDocument(o, s);
    }
    return B();
}

/** Encodes a document for storage locally. */ function ni(t, e, n) {
    var r = ri(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var a = e.key.path.toArray(), u = oi(e.version), c = e.hasCommittedMutations;
        return new Dr(
        /* unknownDocument= */ null, new Nr(a, u), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = oi(e.version);
        return new Dr(new _r(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function ai(t, e) {
    ...
    return new Xr(e.batchId, a, n, s);
}

/** Decodes a DbTarget into TargetData */ function ui(t) {
    var e, n, r = si(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? si(t.lastLimboFreeSnapshotVersion) : at.min();
    return void 0 !== t.query.documents ? (K(1 === (n = t.query).documents.length), 
    e = Ie(pe(Yn(n.documents[0])))) : e = function(t) {
        return Ie(ir(t));
    }(t.query), new Zr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, mt.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function ci(t, e) {
    var n, r = oi(e.snapshotVersion), i = oi(e.lastLimboFreeSnapshotVersion);
    n = Jt(e.target) ? nr(t.Wt, e.target) : rr(t.Wt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new kr(e.targetId, Wt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ function li(t) {
    return Jr(t, Or.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function di(t) {
    return Jr(t, Pr.store);
}
 ...
 */ var pi = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Gt.add(e), qr.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return qr.resolve(this.Gt.getEntries(e));
    }, t;
}(), yi = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new vn(lt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new vn(lt.comparator)).toArray();
    }, t;
}(), vi = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return mi(t).Lt(r).next((function(t) {
 ...
 */
function bi(t, e, n) {
    var r = t.store(Er.store), i = t.store(Sr.store), o = [], s = IDBKeyRange.only(n.batchId), a = 0, u = r.Kt({
        range: s
    }, (function(t, e, n) {
        return a++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = Sr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return qr.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ wi.DEFAULT_COLLECTION_PERCENTILE = 10, 
wi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, wi.DEFAULT = new wi(41943040, wi.DEFAULT_COLLECTION_PERCENTILE, wi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
wi.DISABLED = new wi(-1, 0, 0);
...
var Ti = /** @class */ function() {
     ...
     */
    t, e, n, r) {
        this.userId = t, this.N = e, this.Ht = n, this.referenceDelegate = r, 
        /**
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(a) {
            K("number" == typeof a);
            for (var u = new Xr(a, e, n, r), c = function(t, e, n) {
            ...
            }(i.N, i.userId, u), h = [], f = new vn((function(t, e) {
                return rt(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = Sr.key(i.userId, p.key.path, a);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, Sr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.Ht.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Jt[a] = u.keys();
            })), qr.waitFor(h).next((function() {
                return u;
            }));
        }));
        ...
        return Si(t).get(e).next((function(t) {
            return t ? (K(t.userId === n.userId), ai(n.N, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Xt = function(t, e) {
        var n = this;
        return this.Jt[e] ? qr.resolve(this.Jt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Jt[e] = r, r;
            }
        ...
        return Si(t).Kt({
            ...
            e.userId === n.userId && (K(e.batchId >= r), o = ai(n.N, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Si(t).Lt(Er.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return ai(e.N, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = Sr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return Ni(t).Kt({
            range: i
        }, (function(r, i, s) {
            var a = r[0], u = r[1], c = r[2], h = wr(u);
            ...
            return Si(t).get(c).next((function(t) {
                if (!t) throw B();
                K(t.userId === n.userId), o.push(ai(n.N, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new vn(rt), i = [];
        return e.forEach((function(e) {
            var o = Sr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), a = Ni(t).Kt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], a = t[1], u = t[2], c = wr(a);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(a);
        })), qr.waitFor(i).next((function() {
            return n.Zt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Sr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), a = new vn(rt);
        return Ni(t).Kt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], u = t[1], c = t[2], h = wr(u);
        ...
        return e.forEach((function(e) {
            i.push(Si(t).get(e).next((function(t) {
                if (null === t) throw B();
                K(t.userId === n.userId), r.push(ai(n.N, t));
            })));
        })), qr.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return bi(t.Qt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.te(e.batchId);
            })), qr.forEach(r, (function(e) {
    ...
    t.prototype.te = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            if (!n) return qr.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Sr.prefixForUser(e.userId)), i = [];
            return Ni(t).Kt({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
    ...
    t.prototype.ee = function(t) {
        var e = this;
        return _i(t).get(this.userId).next((function(t) {
 ...
 */ function Ei(t, e, n) {
    var r = Sr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Ni(t).Kt({
        range: o,
        qt: !0
    }, (function(t, n, r) {
 ...
 */ function Si(t) {
    return Jr(t, Er.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ni(t) {
    return Jr(t, Sr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function _i(t) {
    return Jr(t, Tr.store);
}
 ...
 */ var Di = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        var e = this;
        return this.re(t).next((function(n) {
            var r = new Di(n.highestTargetId);
            return n.highestTargetId = r.next(), e.oe(t, n).next((function() {
                return n.highestTargetId;
            }));
        }));
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return this.re(t).next((function(t) {
            return at.fromTimestamp(new st(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        var r = this;
        return this.re(t).next((function(i) {
            return i.highestListenSequenceNumber = e, n && (i.lastRemoteSnapshotVersion = n.toTimestamp()), 
            e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), r.oe(t, i);
        }));
    }, t.prototype.addTargetData = function(t, e) {
        var n = this;
        return this.ae(t, e).next((function() {
            return n.re(t).next((function(r) {
                return r.targetCount += 1, n.ce(e, r), n.oe(t, r);
            }));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return K(e.targetCount > 0), e.targetCount -= 1, n.oe(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.forEachTarget = function(t, e) {
        ...
        return Ci(t).get(xr.key).next((function(t) {
            return K(null !== t), t;
        }));
    }, t.prototype.oe = function(t, e) {
        return Ci(t).put(xr.key, e);
    }, t.prototype.ae = function(t, e) {
        return ki(t).put(ci(this.N, e));
    }, 
    /**
    ...
    t.prototype.ce = function(t, e) {
        ...
        var n = Wt(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return ki(t).Kt({
            range: r,
            index: kr.queryTargetsIndexName
        }, (function(t, n, r) {
            var o = ui(n);
            // After finding a potential match, check that the target is
            // actually equal to the requested target.
                        Yt(e, o.target) && (i = o, r.done());
        })).next((function() {
            return i;
        }));
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = vr(e.path);
            i.push(o.put(new Cr(n, s))), i.push(r.referenceDelegate.addReference(t, n, e));
        })), qr.waitFor(i);
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        var r = this, i = xi(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return qr.forEach(e, (function(e) {
            var o = vr(e.path);
            return qr.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = xi(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = xi(t), i = Nn();
        return r.Kt({
            range: n,
            qt: !0
        }, (function(t, e, n) {
            var r = wr(t[1]), o = new At(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = vr(e.path), r = IDBKeyRange.bound([ n ], [ ot(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return xi(t).Kt({
            index: Cr.documentTargetsIndex,
            qt: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
 ...
 */
function ki(t) {
    return Jr(t, kr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function Ci(t) {
    return Jr(t, xr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function xi(t) {
    return Jr(t, Cr.store);
}
 ...
 */ function Li(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== G.FAILED_PRECONDITION || t.message !== Mr) throw t;
 ...
 * limitations under the License.
 */ function Ri(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = rt(n, i);
    return 0 === s ? rt(r, o) : s;
}
 ...
 */ var Oi = /** @class */ function() {
    function t(t) {
        this.ue = t, this.buffer = new vn(Ri), this.he = 0;
    }
    ...
    return t.prototype.start = function(t) {
        ...
        var e = this, i = this.de ? 3e5 : 6e4;
        M("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.we = null, this.de = !0, n.label = 1;
                      ...
                      case 3:
                        return zr(e = n.sent()) ? (M("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        var n = this;
        if (0 === e) return qr.resolve(tt.T);
        var r = new Oi(e);
        return this.me.forEachTarget(t, (function(t) {
            return r.fe(t.sequenceNumber);
        })).next((function() {
            return n.me.ye(t, (function(t) {
                return r.fe(t);
            }));
        })).next((function() {
            return r.maxValue;
        ...
        qr.resolve(gi)) : this.getCacheSize(t).next((function(r) {
            return r < n.params.cacheSizeCollectionThreshold ? (M("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.cacheSizeCollectionThreshold), 
            gi) : n.pe(t, e);
        }));
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return e > c.params.maximumSequenceNumbersToCollect ? (M("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.params.maximumSequenceNumbersToCollect + " from " + e), 
            ...
            return u = Date.now(), P() <= f.DEBUG && M("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (u - a) + "ms\nTotal Duration: " + (u - h) + "ms"), 
            qr.resolve({
                didRun: !0,
    ...
    t.prototype.Ie = function(t, e) {
        return function(t, e) {
            var n = !1;
            return _i(t).jt((function(r) {
                return Ei(t, r, e).next((function(t) {
                    return t && (n = !0), qr.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
        ...
        return this.Te(t, (function(s, a) {
            if (a <= e) {
                var u = n.Ie(t, s).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), xi(t).delete([ 0, vr(s.path) ]);
                    }));
                }));
                i.push(u);
            }
 ...
 */ var qi = /** @class */ function() {
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? qr.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        return this.getMetadata(t).next((function(r) {
            return r.byteSize += e, n.Ae(t, r);
        }));
    }, t.prototype.getEntry = function(t, e) {
        var n = this;
        return zi(t).get(Gi(e)).next((function(t) {
            return n.Re(e, t);
        }));
    }, 
    /**
    ...
    t.prototype.ve = function(t, e) {
        var n = this, r = wn(), i = new dn(At.comparator);
        return this.Pe(t, e, (function(t, e) {
            var o = n.Re(t, e);
            r = r.insert(t, o), i = i.insert(t, Ii(e));
        })).next((function() {
            return {
                documents: r,
                Ve: i
        ...
        if (e.isEmpty()) return qr.resolve();
        ...
        var r = this, i = wn(), o = e.path.length + 1, s = {};
        if (n.isEqual(at.min())) {
            ...
            var u = e.path.toArray(), c = ri(n);
            s.range = IDBKeyRange.lowerBound([ u, c ], 
            /* open= */ !0), s.index = Dr.collectionReadTimeIndex;
        }
        return zi(t).Kt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var a = ei(r.N, n);
                e.path.isPrefixOf(a.key.path) ? _e(e, a) && (i = i.insert(a.key, a)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Ki(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return ji(t).get(Ar.key).next((function(t) {
            return K(!!t), t;
        }));
    }, t.prototype.Ae = function(t, e) {
        return ji(t).put(Ar.key, e);
    }, 
    /**
    ...
    t.prototype.Re = function(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!n.isNoDocument() || !n.version.isEqual(at.min())) return n;
        }
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Se = t, r.trackRemovals = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.De = new qi((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new vn((function(t, e) {
            return rt(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var a = e.De.get(o);
            if (s.document.isValidDocument()) {
                var u = ni(e.Se.N, s.document, e.getReadTime(o));
                i = i.add(o.path.popLast());
                var c = Ii(u);
                r += c - a, n.push(e.Se.addEntry(t, o, u));
            } else if (r -= a, e.trackRemovals) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var h = ni(e.Se.N, Gt.newNoDocument(o, at.min()), e.getReadTime(o));
                n.push(e.Se.addEntry(t, o, h));
            } else n.push(e.Se.removeEntry(t, o));
        })), i.forEach((function(r) {
            n.push(e.Se.Ht.addToCollectionParentIndex(t, r));
        })), n.push(this.Se.updateMetadata(t, r)), qr.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.Se.be(t, e).next((function(t) {
            return n.De.set(e, t.size), t.document;
        }));
    }, n.prototype.getAllFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
                return this.Se.ve(t, e).next((function(t) {
            var e = t.documents;
            // Note: `getAllFromCache` returns two maps instead of a single map from
            // keys to `DocumentSizeEntry`s. This is to allow returning the
            // `MutableDocumentMap` directly, without a conversion.
            return t.Ve.forEach((function(t, e) {
                n.De.set(t, e);
            })), e;
        }));
    }, n;
 ...
 */ function ji(t) {
    return Jr(t, Ar.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function zi(t) {
    return Jr(t, Dr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Qi = /** @class */ function() {
    function t(t) {
        this.N = t;
    }
    /**
     ...
     */    return t.prototype.Ct = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Cr.store), t.deleteObjectStore(kr.store), t.deleteObjectStore(xr.store);
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Er.store).Lt().next((function(n) {
            ...
            !function(t) {
                ...
                e.createIndex(Dr.readTimeIndex, Dr.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Dr.collectionReadTimeIndex, Dr.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(Dr.store).Kt((function(t, n) {
            e += Ii(n);
        })).next((function() {
            var n = new Ar(e);
        ...
        return n.Lt().next((function(n) {
            return qr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Lt(Er.userMutationsIndex, i).next((function(r) {
    ...
    t.prototype.xe = function(t) {
        var e = t.store(Cr.store), n = t.store(Dr.store);
        return t.store(xr.store).get(xr.key).next((function(t) {
            var r = [];
            return n.Kt((function(n, i) {
                var o = new lt(n), s = function(t) {
                    return [ 0, vr(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? qr.resolve() : function(n) {
                        return e.put(new Cr(0, vr(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return qr.waitFor(r);
        ...
        var n = e.store(Lr.store), r = new yi, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(Dr.store).Kt({
            qt: !0
        }, (function(t, e) {
            var n = new lt(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(Sr.store).Kt({
                qt: !0
            }, (function(t, e) {
                t[0];
                var n = t[1];
        ...
        var e = this, n = t.store(kr.store);
        return n.Kt((function(t, r) {
            var i = ui(r), o = ci(e.N, i);
            return n.put(o);
        }));
    }, t;
}();
...
function Hi(t) {
    t.createObjectStore(Cr.store, {
        keyPath: Cr.keyPath
    }).createIndex(Cr.documentTargetsIndex, Cr.documentTargetsKeyPath, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(kr.store, {
        keyPath: kr.keyPath
    }).createIndex(kr.queryTargetsIndexName, kr.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(xr.store);
}

var Wi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Yi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        this.Oe = o, this.window = s, this.document = a, this.Fe = c, this.Me = h, this.Le = null, 
        ...
        }, !t.bt()) throw new Q(G.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Mi(this, i), this.We = n + "main", this.N = new ti(u), 
        this.Ge = new Br(this.We, 11, new Qi(this.N)), this.ze = new Ai(this.referenceDelegate, this.N), 
        this.Ht = new vi, this.He = function(t, e) {
            return new Bi(t, e);
        }(this.N, this.Ht), this.Je = new fi, this.window && this.window.localStorage ? this.Ye = this.window.localStorage : (this.Ye = null, 
        !1 === h && V("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new Q(G.FAILED_PRECONDITION, Wi);
            return t.Ze(), t.tn(), t.en(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.ze.getHighestSequenceNumber(e);
            }));
        })).then((function(e) {
            t.Le = new tt(e, t.Fe);
        })).then((function() {
            ...
            return t.Ge && t.Ge.close(), Promise.reject(e);
        }));
    }, 
    /**
        ...
        this.Oe.enqueueAndForget((function() {
            return n(e, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.started ? [ 4 /*yield*/ , this.Xe() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.Xe = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Xi(e).put(new Rr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
                ...
                return t.isPrimary && !n ? t.on(e).next((function() {
                    return !1;
                })) : !!n && t.an(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
        ...
        var e = this;
        return Ji(t).get(Ir.key).next((function(t) {
            return qr.resolve(e.cn(t));
        }));
            ...
            return r(this, (function(r) {
                switch (r.label) {
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.Lt().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return qr.forEach(r, (function(t) {
                  ...
                  case 1:
                    ...
                    if (t = r.sent(), this.Ye) for (e = 0, n = t; e < n.length; e++) i = n[e], this.Ye.removeItem(this.dn(i.clientId));
                    r.label = 2;
    ...
    t.prototype.en = function() {
        var t = this;
        this.Ke = this.Oe.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t.Xe().then((function() {
                return t.hn();
            })).then((function() {
                return t.en();
            }));
    ...
    /** Checks whether `client` is the local client. */ t.prototype.cn = function(t) {
    ...
    t.prototype.rn = function(t) {
        var e = this;
        return this.Me ? qr.resolve(!0) : Ji(t).get(Ir.key).next((function(n) {
            ...
            if (null !== n && e.ln(n.leaseTimestampMs, 5e3) && !e.wn(n.ownerId)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Xi(t).Lt().next((function(t) {
            ...
            return e.isPrimary !== t && M("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
    }, t.prototype.shutdown = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.Be = !1, this._n(), this.Ke && (this.Ke.cancel(), this.Ke = null), this.mn(), 
                    this.gn(), [ 4 /*yield*/ , this.Ge.runTransaction("shutdown", "readwrite", [ Ir.store, Rr.store ], (function(e) {
                        var n = new Yr(e, tt.T);
                        return t.on(n).next((function() {
                            return t.un(n);
                        }));
                    })) ];
    ...
    t.prototype.fn = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.ln(t.updateTimeMs, e) && !n.wn(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.pn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Xi(e).Lt().next((function(e) {
        ...
        return Ti.Yt(t, this.N, this.Ht, this.referenceDelegate);
        ...
        return this.Ge.runTransaction(t, o, Fr, (function(o) {
            return i = new Yr(o, r.Le ? r.Le.next() : tt.T), "readwrite-primary" === e ? r.sn(i).next((function(t) {
                return !!t || r.rn(i);
            })).next((function(e) {
                if (!e) throw V("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Oe.enqueueRetryable((function() {
                    return r.Qe(!1);
                })), new Q(G.FAILED_PRECONDITION, Mr);
                return n(i);
            })).next((function(t) {
                return r.an(i).next((function() {
                    return t;
                }));
    ...
    t.prototype.En = function(t) {
        var e = this;
        return Ji(t).get(Ir.key).next((function(t) {
            if (null !== t && e.ln(t.leaseTimestampMs, 5e3) && !e.wn(t.ownerId) && !e.cn(t) && !(e.Me || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Q(G.FAILED_PRECONDITION, Wi);
        }));
    }, 
    /**
    ...
    t.prototype.an = function(t) {
        var e = new Ir(this.clientId, this.allowTabSynchronization, Date.now());
        return Ji(t).put(Ir.key, e);
    }, t.bt = function() {
        return Br.bt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.on = function(t) {
        var e = this, n = Ji(t);
        return n.get(Ir.key).next((function(t) {
            return e.cn(t) ? (M("IndexedDbPersistence", "Releasing primary lease."), n.delete(Ir.key)) : qr.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.ln = function(t, e) {
        var n = Date.now();
        ...
        null !== this.document && "function" == typeof this.document.addEventListener && (this.qe = function() {
            t.Oe.enqueueAndForget((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.Xe();
            }));
    ...
    t.prototype.tn = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Ue = function() {
            ...
            e._n(), d() && navigator.appVersion.match("Version/14") && 
    ...
    /** Removes the zombied client entry if it exists. */ t.prototype.yn = function() {
        if (this.Ye) try {
 ...
 */
function Ji(t) {
    return Jr(t, Ir.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Xi(t) {
    return Jr(t, Rr.store);
}
...
var Zi = function(t, e) {
    ...
    return t.prototype.An = function(t, e) {
        var n = this;
        return this.In.getAllMutationBatchesAffectingDocumentKey(t, e).next((function(r) {
            return n.Rn(t, e, r);
        }));
    }, 
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.Rn = function(t, e, n) {
 ...
 */
        return function(t) {
            return At.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Vn(t, e.path) : we(e) ? this.Sn(t, e, n) : this.Dn(t, e, n);
    }, t.prototype.Vn = function(t, e) {
        // Just do a simple document lookup.
        return this.An(t, new At(e)).next((function(t) {
            var e = In();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.Sn = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = In();
        return this.Ht.getCollectionParents(t, i).next((function(s) {
            return qr.forEach(s, (function(s) {
                var a = function(t, e) {
                    return new le(e, 
                    /*collectionGroup=*/ null, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, t.endAt);
                }(e, s.child(i));
                return r.Dn(t, a, n).next((function(t) {
                    t.forEach((function(t, e) {
                        o = o.insert(t, e);
                    }));
                }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return r = n, o.In.getAllMutationBatchesAffectingQuery(t, e);
        })).next((function(e) {
            return i = e, o.Cn(t, i, r).next((function(t) {
                r = t;
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, a = o.mutations; s < a.length; s++) {
                    var u = a[s], c = u.key, h = r.get(c);
                    null == h && (
                    // Create invalid document to apply mutations on top of
                    h = Gt.newInvalidDocument(c), r = r.insert(c, h)), Je(u, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = Nn(), i = 0, o = e; i < o.length; i++) for (var s = 0, a = o[i].mutations; s < a.length; s++) {
            var u = a[s];
            u instanceof en && null === n.get(u.key) && (r = r.add(u.key));
        }
        var c = n;
        return this.He.getEntries(t, r).next((function(t) {
    ...
    function t(t, e, n, r) {
        this.targetId = t, this.fromCache = e, this.Nn = n, this.xn = r;
    }
    return t.kn = function(e, n) {
    ...
    function t() {}
    /** Sets the document view to query against. */    return t.prototype.$n = function(t) {
        this.On = t;
    }, 
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(at.min()) ? this.Fn(t, e) : this.On.Pn(t, r).next((function(o) {
            var s = i.Mn(e, o);
            return (ye(e) || ve(e)) && i.Ln(e.limitType, s, r, n) ? i.Fn(t, e) : (P() <= f.DEBUG && M("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ne(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Mn = function(t, e) {
     ...
     */
    t.prototype.Ln = function(t, e, n, r) {
        ...
        return P() <= f.DEBUG && M("QueryEngine", "Using full collection scan to execute query:", Ne(e)), 
    ...
    t, e, n, r) {
        this.persistence = t, this.Bn = e, this.N = r, 
        /**
        ...
        /**
             ...
             */
        this.Kn = at.min(), this.In = t.getMutationQueue(n), this.jn = t.getRemoteDocumentCache(), 
        this.ze = t.getTargetCache(), this.Qn = new to(this.jn, this.In, this.persistence.getIndexManager()), 
        this.Je = t.getBundleCache(), this.Bn.$n(this.Qn);
    }
    return t.prototype.collectGarbage = function(t) {
        var e = this;
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (function(n) {
            return t.collect(n, e.Un);
        }));
    }, t;
}();
...
function oo(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = z(t), i = n.In, o = n.Qn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    // Swap out the mutation queue, grabbing the pending mutation batches
                    // before and after.
                    var r;
                    return n.In.getAllMutationBatches(t).next((function(s) {
                        return r = s, i = n.persistence.getMutationQueue(e), 
                        // Recreate our LocalDocumentsView using the new
                        // MutationQueue.
                        o = new to(n.jn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = Nn(), a = 0, u = r
              ...
              case 1:
                return s = r.sent(), [ 2 /*return*/ , (n.In = i, n.Qn = o, n.Bn.$n(n.Qn), s) ];
            }
        }));
    }));
}
 ...
 */ function so(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        var r = e.batch.keys(), i = n.jn.newChangeBuffer({
            trackRemovals: !0
        });
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = qr.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.getEntry(e, t);
                })).next((function(e) {
                    var o = n.docVersions.get(t);
                    K(null !== o), e.version.compareTo(o) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
 ...
 * queue.
 */ function uo(t, e) {
    var n = z(t), r = e.snapshotVersion, i = n.Un;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        var o = n.jn.newChangeBuffer({
            trackRemovals: !0
        });
        ...
        e.targetChanges.forEach((function(e, o) {
            ...
            if (a) {
                ...
                s.push(n.ze.removeMatchingKeys(t, e.removedDocuments, o).next((function() {
                    return n.ze.addMatchingKeys(t, e.addedDocuments, o);
                })));
                var u = e.resumeToken;
     ...
     */
                    function(t, e, n) {
                        ...
                        return K(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize() || (
                    ...
                    }(a, c, e) && s.push(n.ze.updateTargetData(t, c));
                }
            }
        }));
        var a = wn();
        ...
        s.push(co(t, o, e.documentUpdates, r, void 0).next((function(t) {
            a = t;
        }))), !r.isEqual(at.min())) {
            var u = n.ze.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.ze.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(u);
        }
        return qr.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Qn.vn(t, a);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual(at.min()) ? (
            ...
            o = o.insert(n, s)) : M("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", a.version, " Watch version:", s.version);
        })), o;
    }))
    /**
 ...
 */ function fo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.ze.getTargetData(t, e).next((function(i) {
            ...
            r = i, qr.resolve(r)) : n.ze.allocateTargetId(t).next((function(i) {
                return r = new Zr(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.ze.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
        ...
        // the in-memory data
        var r = n.Un.get(t.targetId);
        return (null === r || t.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.Un = n.Un.insert(t.targetId, t), 
...
function lo(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = z(t), o = n.Un.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 4:
                if (!zr(a = r.sent())) throw a;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return M("LocalStore", "Failed to update sequence numbers for target " + e + ": " + a), 
                [ 3 /*break*/ , 5 ];

              case 5:
                return n.Un = n.Un.remove(e), n.qn.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function po(t, e, n) {
    var r = z(t), i = at.min(), o = Nn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = z(t), i = r.qn.get(n);
            return void 0 !== i ? qr.resolve(r.Un.get(i)) : r.ze.getTargetData(e, n);
        }(r, t, Ie(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.ze.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.Bn.getDocumentsMatchingQuery(t, e, n ? i : at.min(), n ? o : Nn());
        })).next((function(t) {
            return {
                documents: t,
                Gn: o
...
// PORTING NOTE: Multi-Tab only.
function yo(t, e) {
    var n = z(t), r = z(n.ze), i = n.Un.get(e);
...
function vo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = z(t), i = wn(), o = ri(n), s = zi(e), a = IDBKeyRange.lowerBound(o, !0);
            return s.Kt({
                index: Dr.readTimeIndex,
                range: a
            }, (function(t, e) {
 ...
 */ function go(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = z(t), s = Nn(), a = wn(), u = En(), c = 0, h = i; c < h.length; c++) f = h[c], 
                l = e.zn(f.metadata.name), f.document && (s = s.add(l)), a = a.insert(l, e.Hn(f)), 
                u = u.insert(l, e.Jn(f.metadata.readTime));
                return d = n.jn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , fo(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return Ie(pe(lt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return co(t, d, a, at.min(), u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
                        return n.ze.removeMatchingKeysForTargetId(t, p.targetId).next((function() {
                            return n.ze.addMatchingKeys(t, s, p.targetId);
                        })).next((function() {
                            return n.Qn.vn(t, e);
                        })).next((function() {
                            return e;
 ...
 */ function wo(t, e, i) {
    return void 0 === i && (i = Nn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , fo(t, Ie(hi(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = z(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.Je.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(mt.EMPTY_BYTE_STRING, r);
                    return o.Un = o.Un.insert(s.targetId, s), o.ze.updateTargetData(t, s).next((function() {
                        return o.ze.removeMatchingKeysForTargetId(t, n.targetId);
                    })).next((function() {
                        return o.ze.addMatchingKeys(t, i, n.targetId);
                    })).next((function() {
                        return o.Je.saveNamedQuery(t, e);
                    }));
                })) ];
            }
        }));
 ...
 */ var bo = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return qr.resolve(this.Yn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return qr.resolve(this.Xn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Zn = new vn(To.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new vn(To.ns)
    ...
    t.prototype.cs = function(t) {
        var e = this, n = new At(new lt([])), r = new To(n, t), i = new To(n, t + 1), o = [];
        ...
        var e = new At(new lt([])), n = new To(e, t), r = new To(e, t + 1), i = Nn();
        return this.es.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new To(t, 0), n = this.Zn.firstAfterOrEqual(e);
    ...
    return t.ts = function(t, e) {
        return At.comparator(t.key, e.key) || rt(t.ls, e.ls);
    }, 
    /** Compare by ID then by key */ t.ns = function(t, e) {
        return rt(t.ls, e.ls) || At.comparator(t.key, e.key);
    }, t;
}(), Eo = /** @class */ function() {
    function t(t, e) {
        ...
        this.ds = new vn(To.ts);
    }
    return t.prototype.checkEmpty = function(t) {
        return qr.resolve(0 === this.In.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.fs;
        ...
        for (var s = 0, a = r; s < a.length; s++) {
            var u = a[s];
            this.ds = this.ds.add(new To(u.key, i)), this.Ht.addToCollectionParentIndex(t, u.key.path.popLast());
        }
        return qr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return qr.resolve(this.ws(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this._s(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return qr.resolve(this.In.length > i ? this.In[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return qr.resolve(0 === this.In.length ? -1 : this.fs - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return qr.resolve(this.In.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        ...
        var o = new To(new At(i), 0), s = new vn(rt);
        ...
        // query.
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === r && (s = s.add(t.ls)), !0);
        }), o), qr.resolve(this.gs(s));
        ...
        var n = this;
        K(0 === this.ys(e.batchId, "removed")), this.In.shift();
        var r = this.ds;
        return qr.forEach(e.mutations, (function(i) {
        ...
        var n = new To(e, 0), r = this.ds.firstAfterOrEqual(n);
        return qr.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.In.length, qr.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new dn(At.comparator), 
    ...
    return t.prototype.addEntry = function(t, e, n) {
        var r = e.key, i = this.docs.get(r), o = i ? i.size : 0, s = this.ps(e);
        return this.docs = this.docs.insert(r, {
            document: e.clone(),
            size: s,
            readTime: n
        }), this.size += s - o, this.Ht.addToCollectionParentIndex(t, r.path.popLast());
    }, 
    /**
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return qr.resolve(n ? n.document.clone() : Gt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = wn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Gt.newInvalidDocument(t));
        })), qr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = wn(), i = new At(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), a = s.key, u = s.value, c = u.document, h = u.readTime;
            if (!e.path.isPrefixOf(a.path)) break;
            h.compareTo(n) <= 0 || _e(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return qr.resolve(r);
    }, t.prototype.Es = function(t, e) {
        return qr.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        ...
        return qr.resolve(this.size);
    }, t;
}(), No = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Se = t, n;
    }
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [];
        return this.changes.forEach((function(r, i) {
            i.document.isValidDocument() ? n.push(e.Se.addEntry(t, i.document, e.getReadTime(r))) : e.Se.removeEntry(r);
        })), qr.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.As = new Io, this.targetCount = 0, this.Rs = Di.se();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return qr.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return qr.resolve(this.Is);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Rs.next(), qr.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        return this.ae(e), this.targetCount += 1, qr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.ae(e), qr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.Ts.delete(e.target), this.As.cs(e.targetId), this.targetCount -= 1, 
        qr.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Ts.forEach((function(s, a) {
            a.sequenceNumber <= e && null === n.get(a.targetId) && (r.Ts.delete(s), o.push(r.removeMatchingKeysForTargetId(t, a.targetId)), 
            i++);
        })), qr.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return qr.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.Ts.get(e) || null;
        return qr.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.As.ss(e, n), qr.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.As.os(e, n);
        ...
        return this.As.cs(e), qr.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.As.hs(e);
        return qr.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return qr.resolve(this.As.containsKey(e));
    }, t;
}(), Do = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.bs = {}, this.Le = new tt(0), this.Be = !1, this.Be = !0, this.referenceDelegate = t(this), 
        this.ze = new _o(this), this.Ht = new pi, this.He = function(t, e) {
            return new So(t, (function(t) {
                return n.referenceDelegate.Ps(t);
            }));
        }(this.Ht), this.N = new ti(e), this.Je = new bo(this.N);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new Eo(this.Ht, this.referenceDelegate), this.bs[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.ze;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        var i = new Ao(this.Le.next());
        return this.referenceDelegate.vs(), n(i).next((function(t) {
            return r.referenceDelegate.Vs(i).next((function() {
                return t;
            }));
        ...
        return qr.or(Object.values(this.bs).map((function(n) {
            return function() {
    ...
    return t.Ns = function(e) {
        ...
        return this.Ds.addReference(n, e), this.xs.delete(n.toString()), qr.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Ds.removeReference(n, e), this.xs.add(n.toString()), qr.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.xs.add(e.toString()), qr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return qr.forEach(this.xs, (function(r) {
            var i = At.fromPath(r);
            return e.ks(t, i).next((function(t) {
                t || n.removeEntry(i);
            }));
        })).next((function() {
            return e.Cs = null, n.apply(t);
        }));
    }, t.prototype.updateLimboDocument = function(t, e) {
        var n = this;
        ...
        var n = this;
        return qr.or([ function() {
            return qr.resolve(n.Ds.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Ss(t, e);
        } ]);
    }, t;
}();
...
var Ro = /** @class */ function() {
    ...
    return t.$s = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new Q(o.error.code, o.error.message))), 
        s ? new t(e, n, o.state, i) : (V("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.$s = function(e, n) {
        ...
        o ? new t(e, i.state, r) : (V("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.Os = function() {
        var t = {
            state: this.state,
    ...
    return t.$s = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Dn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Dt(r.activeTargetIds[s]), 
        o = o.add(r.activeTargetIds[s]);
        return i ? new t(e, o) : (V("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), Fo = /** @class */ function() {
    function t(t, e) {
    ...
    return t.$s = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (V("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Mo = /** @class */ function() {
    function t() {
        this.activeTargetIds = Dn();
    }
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Oe = e, this.persistenceKey = n, this.Ls = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Bs = this.Us.bind(this), 
        this.qs = new dn(rt), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.js = Co(this.persistenceKey, this.Ls), 
        this.Qs = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.qs = this.qs.insert(this.Ls, new Mo), this.Ws = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        this.Gs = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.zs = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), 
        this.Hs = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.bt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.syncEngine.pn() ];

                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ls && (o = this.getItem(Co(this.persistenceKey, i))) && (s = Po.$s(i, o)) && (this.qs = this.qs.insert(s.clientId, s));
                    for (this.Ys(), (a = this.storage.getItem(this.Hs)) && (u = this.Xs(a)) && this.Zs(u), 
                    c = 0, h = this.Ks; c < h.length; c++) f = h[c], this.Us(f);
                    return this.Ks = [], 
        ...
        // `Window.addEventListener`.
            ...
            if (M("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.js) return void V("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Oe.enqueueRetryable((function() {
                return n(e, void 0, void 0, (function() {
                    var t, e, n, o, s, a;
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ws.test(i.key)) {
                                if (null == i.newValue) return t = this.ai(i.key), [ 2 /*return*/ , this.ci(t, null) ];
                                if (e = this.ui(i.key, i.newValue)) return [ 2 /*return*/ , this.ci(e.clientId, e) ];
                            } else if (this.Gs.test(i.key)) {
                                if (null !== i.newValue && (n = this.hi(i.key, i.newValue))) return [ 2 /*return*/ , this.li(n) ];
                            } else if (this.zs.test(i.key)) {
                                if (null !== i.newValue && (o = this.fi(i.key, i.newValue))) return [ 2 /*return*/ , this.di(o) ];
                            } else if (i.key === this.Hs) {
                                if (null !== i.newValue && (s = this.Xs(i.newValue))) return [ 2 /*return*/ , this.Zs(s) ];
                            } else if (i.key === this.Qs) (a = function(t) {
                                var e = tt.T;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue)) !== tt.T && this.sequenceNumberHandler(a); else if (i.key === this.Js) return [ 2 /*return*/ , this.syncEngine.wi() ];
                        } else this.Ks.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    }, Object.defineProperty(t.prototype, "si", {
        get: function() {
        ...
        var r = new Ro(this.currentUser, t, e, n), i = xo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Os());
    ...
    }, t.prototype.ii = function(t, e, n) {
        var r = Lo(this.persistenceKey, t), i = new Oo(t, e, n);
        this.setItem(r, i.Os());
    ...
    t.prototype.hi = function(t, e) {
        var n = this.Gs.exec(t), r = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return Ro.$s(new L(i), r, e);
    }, 
    /**
    ...
    t.prototype.fi = function(t, e) {
        var n = this.zs.exec(t), r = Number(n[1]);
        return Oo.$s(r, e);
    }, 
    /**
    ...
    t.prototype.Xs = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine._i(t.batchId, t.state, t.error) ] : (M("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.qs.insert(t, e) : this.qs.remove(t), i = this.ti(this.qs), o = this.ti(r), s = [], a = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || a.push(t);
        })), this.syncEngine.gi(s, a).then((function() {
            n.qs = r;
        }));
    ...
    function t() {
        this.yi = new Mo, this.pi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.yi = new Mo, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.qi = function(t, e, n, r) {
            ...
            s.listenOnce(S.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case N.TIMEOUT:
                        M("Connection", 'RPC "' + t + '" timed out'), o(new Q(G.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case N.HTTP_ERROR:
                        var n = s.getStatus();
                        if (M("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new Q(a, r.message));
                            } else o(new Q(G.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new Q(G.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    }, n.prototype.ji = function(t, e) {
        var n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = _(), i = D(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new A({})), this.Ui(o.initMessageHeaders, e), 
        ...
        p() || y() || v() || m() || g() || w() || (o.httpHeadersOverwriteParam = "$httpHeaders");
        var s = n.join("");
        M("Connection", "Creating WebChannel: " + s, o);
        var a = r.createWebChannel(s, o), u = !1, c = !1, h = new jo({
            vi: function(t) {
                c ? M("Connection", "Not sending because WebChannel is closed:", t) : (u || (M("Connection", "Opening WebChannel transport."), 
                a.open(), u = !0), M("Connection", "WebChannel sending:", t), a.send(t));
            },
            Vi: function() {
                return a.close();
            }
        ...
        return f(a, k.EventType.OPEN, (function() {
            c || M("Connection", "WebChannel transport opened.");
        })), f(a, k.EventType.CLOSE, (function() {
            c || (c = !0, M("Connection", "WebChannel transport closed"), h.$i());
        })), f(a, k.EventType.ERROR, (function(t) {
            c || (c = !0, q("Connection", "WebChannel transport errored:", t), h.$i(new Q(G.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    void 0 === s && (s = G.INTERNAL, u = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    c = !0, h.$i(new Q(s, u)), a.close();
                } else M("Connection", "WebChannel received:", n), h.Oi(n);
            }
        })), f(i, C.STAT_EVENT, (function(t) {
            t.stat === x.PROXY ? M("Connection", "Detected buffering proxy") : t.stat === x.NOPROXY && M("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.Li = function(t, e, n, r) {
        var i = this.Bi(t, e);
        M("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.Ui(o, r), this.qi(t, i, o, n).then((function(t) {
            return M("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw q("RestConnection", t + " failed with error: ", e, "url: ", i, "request:", n), 
            e;
        }));
    }, t.prototype.Ki = function(t, e, n, r) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.Li(t, e, n, r);
    }, 
    /**
 ...
 * limitations under the License.
 */ function Ho(t) {
    return new qn(t, /* useProto3Json= */ !0);
}
 ...
 */ var Wo = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Oe = t, this.timerId = e, this.Qi = n, this.Wi = r, this.Gi = i, this.zi = 0, 
        this.Hi = null, 
    ...
    t.prototype.Xi = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.zi + this.Zi()), r = Math.max(0, Date.now() - this.Ji), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && M("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.zi + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.Hi = this.Oe.enqueueAfterDelay(this.timerId, i, (function() {
            return e.Ji = Date.now(), t();
        })), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.Zi = function() {
        return (Math.random() - .5) * this.zi;
    }, t;
}(), Yo = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.Oe = t, this.er = n, this.nr = r, this.credentialsProvider = i, this.listener = o, 
        ...
        /**
             ...
             * close.
             */
        this.sr = 0, this.ir = null, this.stream = null, this.rr = new Wo(t, e)
        /**
    ...
    t.prototype.stop = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.ar() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.dr = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                return this.cr() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype._r = function() {
    ...
    t.prototype.mr = function() {}, t.prototype.auth = function() {
        ...
        var e = this.gr(this.sr), n = this.sr;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new Q(G.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.pr(e);
            }));
        }));
    }, t.prototype.yr = function(t) {
        var e = this, n = this.gr(this.sr);
        this.stream = this.Er(t), this.stream.Si((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.listener.Si();
            }));
        ...
        var t = this;
        this.state = 4 /* Backoff */ , this.rr.Xi((function() {
    ...
    t.prototype.gr = function(t) {
        ...
        return function(n) {
            e.Oe.enqueueAndForget((function() {
                return e.sr === t ? n() : (M("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.Er = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.D ? (K(void 0 === e || "string" == typeof e), mt.fromBase64String(e || "")) : (K(void 0 === e || e instanceof Uint8Array), 
                    mt.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, a = s && function(t) {
                    var e = void 0 === t.code ? G.UNKNOWN : ln(t.code);
                    return new Q(e, t.message || "");
                }(s);
                n = new Ln(r, i, o, a || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var u = e.documentChange;
                u.document, u.document.name, u.document.updateTime;
                var c = Hn(t, u.document.name), h = jn(u.document.updateTime), f = new jt({
                    mapValue: {
                        fields: u.document.fields
                    }
                }), l = Gt.newFoundDocument(c, h, f), d = u.targetIds || [], p = u.removedTargetIds || [];
                n = new Cn(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Hn(t, y.document), m = y.readTime ? jn(y.readTime) : at.min(), g = Gt.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new Cn([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Hn(t, b.document), T = b.removedTargetIds || [];
                n = new Cn([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, N = new hn(S), _ = E.targetId;
                n = new xn(_, N);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? at.min() : e.readTime ? jn(e.readTime) : at.min();
        }(t);
    ...
    n.prototype.Ir = function(t) {
        ...
        e.database = Jn(this.N), e.addTarget = function(t, e) {
            ...
            return (n = Jt(r) ? {
                ...
                query: rr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Bn(t, e.resumeToken) : e.snapshotVersion.compareTo(at.min()) > 0 && (
    ...
    return t(n, e), Object.defineProperty(n.prototype, "br", {
        /**
    ...
    n.prototype.start = function() {
        this.Rr = !1, this.lastStreamToken = void 0, e.prototype.start.call(this);
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (K(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = jn(e)), new Ge(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = jn(t.commitTime);
            return this.listener.vr(n, e);
        }
        // The first response is always the handshake response
                return K(!t.writeResults || 0 === t.writeResults.length), this.Rr = !0, 
        this.listener.Vr();
    }, 
    /**
    ...
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.Pr = function(t) {
        var e = this, n = {
...
}(Yo), $o = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).credentials = t, i.nr = n, i.N = r, i.Dr = !1, 
        i;
    }
    return t(n, e), n.prototype.Cr = function() {
        if (this.Dr) throw new Q(G.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Li = function(t, e, n) {
        ...
        return this.Cr(), this.credentials.getToken().then((function(i) {
            return r.nr.Li(t, e, n, i);
        })).catch((function(t) {
            throw "FirebaseError" === t.name ? (t.code === G.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new Q(G.UNKNOWN, t.toString());
        }));
    }, 
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.Ki = function(t, e, n) {
        var r = this;
        return this.Cr(), this.credentials.getToken().then((function(i) {
            return r.nr.Ki(t, e, n, i);
        })).catch((function(t) {
            throw "FirebaseError" === t.name ? (t.code === G.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new Q(G.UNKNOWN, t.toString());
        }));
    ...
    return t.prototype.Or = function() {
        var t = this;
        0 === this.Nr && (this.Fr("Unknown" /* Unknown */), this.kr = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.kr = null, t.Mr("Backend didn't respond within 10 seconds."), t.Fr("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.$r ? (V(e), this.$r = !1) : M("OnlineStateTracker", e);
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.jr = [], this.Qr = s, this.Qr.Ei((function(t) {
        i.enqueueAndForget((function() {
            return n(a, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return cs(this) ? (M("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = z(t)).Kr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ns(e) ];

                                      case 1:
                                        return n.sent(), e.Wr.set("Unknown" /* Unknown */), e.Kr.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , es(e) ];
 ...
 */ function is(t, e) {
    var n = z(t), r = Ss(n);
    n.qr.delete(e), r.cr() && ss(n, e), 0 === n.qr.size && (r.cr() ? r.lr() : cs(n) && 
...
function us(t) {
    return cs(t) && !Ss(t).ar() && t.qr.size > 0;
}

function cs(t) {
    return 0 === z(t).Kr.size;
}
...
function ls(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(n) {
            ...
            t.Wr.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function ds(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.Wr.set("Online" /* Online */), !(e instanceof Ln && 2 /* Removed */ === e.state && e.cause)) 
                    ...
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                r.sent(), t.qr.delete(s), t.Gr.removeTarget(s), r.label = 3;
              ...
              case 3:
                return o = u.sent(), M("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), o), 
                [ 4 /*yield*/ , ps(t, o) ];
              ...
              case 6:
                if (e instanceof Cn ? t.Gr.rt(e) : e instanceof xn ? t.Gr.ft(e) : t.Gr.ct(e), i.isEqual(at.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , ao(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.qr.set(e, n.withResumeToken(mt.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Zr(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            os(t, r);
                        }
              ...
              case 11:
                return M("RemoteStore", "Failed to raise snapshot:", a = u.sent()), [ 4 /*yield*/ , ps(t, a) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Kr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ns(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t.Wr.set("Offline" /* Offline */), i || (
                // Use a simple read operation to determine if IndexedDB recovered.
                // Ideally, we would expose a health check directly on SimpleDb, but
                // RemoteStore only has access to persistence through LocalStore.
                i = function() {
                    return ao(t.localStore);
                }), 
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Kr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , es(t) ];
...
function vs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = z(t), n = Ns(e), i = e.Ur.length > 0 ? e.Ur[e.Ur.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , ho(e.localStore, i) ];

              case 3:
                return null === (o = r.sent()) ? (0 === e.Ur.length && n.lr(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Ur.push(e);
                    var n = Ns(t);
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , ps(e, s) ];
...
function ms(t) {
    return cs(t) && !Ns(t).ar() && t.Ur.length > 0;
}
...
function bs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = Ns(t), n = 0, i = t.Ur; n < i.length; n++) o = i[n], e.Pr(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Is(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.Ur.shift(), o = $r.from(n, e, i), [ 4 /*yield*/ , ys(t, (function() {
...
function Ts(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && Ns(t).br ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return fn(i = e.code) && i !== G.ABORTED ? (n = t.Ur.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ns(t).hr(), [ 4 /*yield*/ , ys(t, (function() {
 ...
 */ function Es(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = z(t), e ? (n.Kr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , es(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Kr.add(2 /* IsSecondary */), [ 4 /*yield*/ , ns(n) ]);

              case 3:
                r.sent(), n.Wr.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function Ss(t) {
    ...
    t.zr = function(t, e, n) {
        var r = z(t);
        return r.Cr(), new Jo(e, r.nr, r.credentials, r.N, n);
    }(t.datastore, t.asyncQueue, {
        Si: fs.bind(null, t),
        Ci: ls.bind(null, t),
        Tr: ds.bind(null, t)
    }), t.jr.push((function(i) {
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.zr.hr(), us(t) ? as(t) : t.Wr.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Ns(t) {
    ...
    t.Hr = function(t, e, n) {
        var r = z(t);
        return r.Cr(), new Xo(e, r.nr, r.credentials, r.N, n);
    }(t.datastore, t.asyncQueue, {
        Si: ws.bind(null, t),
        Ci: Ts.bind(null, t),
        Vr: bs.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Hr.hr(), [ 4 /*yield*/ , vs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , t.Hr.stop() ];

                  case 3:
                    e.sent(), t.Ur.length > 0 && (M("RemoteStore", "Stopping write stream with " + t.Ur.length + " pending writes"), 
                    t.Ur = []), e.label = 4;
...
var _s = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new H, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
 ...
 */ function Ds(t, e) {
    if (V("AsyncQueue", e + ": " + t), zr(t)) return new Q(G.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var As = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = In(), this.sortedSet = new dn(this.comparator)
        /**
    ...
    this.queries = new qi((function(t) {
        return Se(t);
    }), Ee), this.onlineState = "Unknown" /* Unknown */ , this.Zr = new Set;
};
 ...
 */ function Rs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = z(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new xs), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return a.Xr = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return u = r.sent(), c = Ds(u, "Initialization of query '" + Ne(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.eo(n.onlineState), s.Xr && e.no(s.Xr) && Ms(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Os(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, a;
        return r(this, (function(r) {
            return n = z(t), i = e.query, o = !1, (s = n.queries.get(i)) && (a = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(a, 1), 
 ...
 */ var Vs = /** @class */ function() {
    ...
    return t.prototype.no = function(t) {
        ...
        var o = !1;
        return this.io ? this.oo(t) && (this.so.next(t), o = !0) : this.ao(t, this.onlineState) && (this.co(t), 
        o = !0), this.ro = t, o;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.eo = function(t) {
        ...
        t = Cs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.io = !0, 
        this.so.next(t);
    }, t;
}(), qs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Hn = function(t) {
        return t.metadata.exists ? Zn(this.N, t.document, !1) : Gt.newNoDocument(this.zn(t.metadata.name), this.Jn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Ks(t)
        /**
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , go(this.localStore, new Us(this.N), this.documents, this.lo.id) ];

                  case 1:
                    t = r.sent(), e = this.wo(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , wo(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new Zi(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var js = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Nn(), this.po = De(t), this.Eo = new As(this.po);
    }
    ...
    t.prototype.Io = function(t, e) {
        var n = this, r = e ? e.Ao : new ks, i = e ? e.Eo : this.Eo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, a = !1, u = ye(this.query) && i.size === this.query.limit ? i.last() : null, c = ve(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = _e(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), ye(this.query) || ve(this.query)) for (;s.size > this.query.limit; ) {
            var h = ye(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        var s = e ? this.Po() : [], a = 0 === this.yo.size && this.current ? 1 /* Synced */ : 0 /* Local */ , u = a !== this.mo;
        return this.mo = a, 0 !== o.length || u ? {
            snapshot: new Cs(this.query, t.Eo, i, o, t.mutatedKeys, 0 /* Local */ === a, u, 
            /* excludesMetadataChanges= */ !1),
            vo: s
        } : {
            vo: s
    ...
    t.prototype.bo = function(t) {
        ...
        // updating many documents.
                var e = this.yo;
        this.yo = Nn(), this.Eo.forEach((function(e) {
            t.Vo(e.key) && (t.yo = t.yo.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.yo.has(e) || n.push(new zs(e));
    ...
    t.prototype.Do = function() {
        return Cs.fromInitialDocuments(this.query, this.Eo, this.mutatedKeys, 0 /* Local */ === this.mo);
    }, t;
}(), Qs = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.No = {}, this.xo = new qi((function(t) {
            return Se(t);
        }), Ee), this.ko = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Oo = new dn(At.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Fo = new Map, this.Mo = new Io, 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                i = s.targetId, n.sharedClientState.addLocalQueryTarget(i), o = s.view.Do(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , fo(n.localStore, Ie(e)) ];

              case 2:
                return a = r.sent(), u = n.sharedClientState.addLocalQueryTarget(a.targetId), i = a.targetId, 
                [ 4 /*yield*/ , Js(n, e, i, "current" === u) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && rs(n.remoteStore, a), r.label = 4;
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Io(i), n.Ln ? [ 4 /*yield*/ , po(t.localStore, e.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var r = t.documents;
                                        return e.view.Io(r, n);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (ca(t, e.targetId, a.vo), 
                                    a.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , po(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), a = new Gs(e, s.Gn), u = a.Io(s.documents), c = kn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = a.applyChanges(u, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), ca(t, i, h.vo), f = new Qs(e, i, a), 
                [ 2 /*return*/ , (t.xo.set(e, f), t.ko.has(i) ? t.ko.get(i).push(e) : t.ko.set(i, [ e ]), 
                h.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function Xs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = z(t), i = n.xo.get(e), (o = n.ko.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.ko.set(i.targetId, o.filter((function(t) {
                    return !Ee(t, e);
                }))), void n.xo.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , lo(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), is(n.remoteStore, i.targetId), 
                    aa(n, i.targetId);
                })).catch(Li) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return aa(n, i.targetId), [ 4 /*yield*/ , lo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Qn.Pn(t, o).next((function(o) {
                            ...
                            var s = [], a = 0, u = e; a < u.length; a++) {
                                var c = u[a], h = Xe(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new en(c.key, h, zt(h.value.mapValue), Qe.exists(!0)));
                            }
                            return r.In.addMutationBatch(t, i, s, e);
                        }));
                    })).then((function(t) {
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new dn(rt)), r = r.insert(e, n), t.Lo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , la(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , vs(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), a = Ds(s, "Failed to persist write"), i.reject(a), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , uo(n.localStore, e) ];
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    K(t.addedDocuments.size + t.modifiedDocuments.size + t.removedDocuments.size <= 1), 
                    t.addedDocuments.size > 0 ? r.Co = !0 : t.modifiedDocuments.size > 0 ? K(r.Co) : t.removedDocuments.size > 0 && (K(r.Co), 
                    r.Co = !1));
                })), [ 4 /*yield*/ , la(n, i, e) ];
 ...
 */ function ta(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.No.Tr(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = z(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Fo.get(e), 
                (s = o && o.key) ? (a = (a = new dn(At.comparator)).insert(s, Gt.newNoDocument(s, at.min())), 
                u = Nn().add(s), c = new An(at.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new vn(rt), a, u), [ 4 /*yield*/ , Zs(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Oo = n.Oo.remove(s), n.Fo.delete(e), fa(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , lo(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return aa(n, e, i);
                })).catch(Li) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , so(n.localStore, e) ];
              ...
              case 2:
                ...
                sa(n, i, /*error=*/ null), oa(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , la(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.In.lookupMutationBatch(t, e).next((function(e) {
                            return K(null !== e), r = e.keys(), n.In.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.In.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Qn.Pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                sa(n, e, i), oa(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , la(n, o) ];
 ...
 */ function ia(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                cs((n = z(t)).remoteStore) || M("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 2:
                return -1 === (i = r.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((o = n.Bo.get(i) || []).push(e), 
                n.Bo.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return s = r.sent(), a = Ds(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function sa(t, e, n) {
    var r = z(t), i = r.Lo[r.currentUser.toKey()];
...
function aa(t, e, n) {
    ...
    for (var r = 0, i = t.ko.get(e); r < i.length; r++) {
        var o = i[r];
        t.xo.delete(o), n && t.No.jo(o, n);
    }
    t.ko.delete(e), t.isPrimaryClient && t.Mo.cs(e).forEach((function(e) {
        t.Mo.containsKey(e) || 
...
function ua(t, e) {
    ...
    var n = t.Oo.get(e);
    null !== n && (is(t.remoteStore, n), t.Oo = t.Oo.remove(e), t.Fo.delete(n), fa(t));
}

function ca(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof js ? (t.Mo.addReference(o.key, e), ha(t, o)) : o instanceof zs ? (M("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.Mo.removeReference(o.key, e), t.Mo.containsKey(o.key) || 
        // We removed the last reference for this key
        ua(t, o.key)) : B();
    }
}
...
function ha(t, e) {
    ...
    t.Oo.get(n) || t.$o.has(r) || (M("SyncEngine", "New document in limbo: " + n), t.$o.add(r), 
    fa(t));
}
 ...
 */ function fa(t) {
    for (;t.$o.size > 0 && t.Oo.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.$o.values().next().value;
        t.$o.delete(e);
        var n = new At(lt.fromString(e)), r = t.Uo.next();
        t.Fo.set(r, new Hs(n)), t.Oo = t.Oo.insert(n, r), rs(t.remoteStore, new Zr(Ie(pe(n.path)), r, 2 /* LimboResolution */ , tt.T));
    }
}
...
function la(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = z(t), s = [], a = [], u = [], o.xo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.xo.forEach((function(t, n) {
                    u.push(o.Ko(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = eo.kn(n.targetId, t);
                            a.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.No.Tr(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return qr.forEach(e, (function(e) {
                                        return qr.forEach(e.Nn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return qr.forEach(e.xn, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) a = s[o], u = a.targetId, a.fromCache || (c = n.Un.get(u), 
                                h = c.snapshotVersion, f = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.Un = n.Un.insert(u, f));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
...
function da(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = z(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (M("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , oo(n.localStore, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.Bo.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new Q(G.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.Bo.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , la(n, i.Wn) ];
...
function pa(t, e) {
    var n = z(t), r = n.Fo.get(e);
    if (r && r.Co) return Nn().add(r.key);
    var i = Nn(), o = n.ko.get(e);
    if (!o) return i;
    for (var s = 0, a = o; s < a.length; s++) {
        var u = a[s], c = n.xo.get(u);
 ...
 */ function ya(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , po((n = z(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.So(i), [ 2 /*return*/ , (n.isPrimaryClient && ca(n, e.targetId, o.vo), 
                o) ];
            }
        }));
    }));
...
function va(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , vo((e = z(t)).localStore).then((function(t) {
                return la(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Xt(t, e).next((function(e) {
                            return e ? n.Qn.Pn(t, e) : qr.resolve(null);
                        }));
                    }));
                }((n = z(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , vs(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                sa(n, e, o || null), oa(n, e), function(t, e) {
                    z(z(t).In).te(e);
                }(n.localStore, e)) : B(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , la(n, s) ];
              ...
              case 6:
                ...
                // as applicable.
                M("SyncEngine", "Cannot apply mutation batch with id: " + e), r.label = 7;
...
function ga(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return Sa(n = z(t)), Na(n), !0 !== e || !0 === n.qo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , wa(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.qo = !0, [ 4 /*yield*/ , Es(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, a = o; s < a.length; s++) u = a[s], rs(n.remoteStore, u);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== e || !1 === n.qo ? [ 3 /*break*/ , 7 ] : (c = [], h = Promise.resolve(), 
                n.ko.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return aa(n, e), lo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), is(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , wa(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Fo.forEach((function(t, n) {
                        is(e.remoteStore, n);
                    })), e.Mo.us(), e.Fo = new Map, e.Oo = new dn(At.comparator);
                }(n), n.qo = !1, [ 4 /*yield*/ , Es(n.remoteStore, !1) ];
...
function wa(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = z(t), i = [], o = [], s = 0, a = e, r.label = 1;

              case 1:
                return s < a.length ? (u = a[s], c = void 0, (h = n.ko.get(u)) && 0 !== h.length ? [ 4 /*yield*/ , fo(n.localStore, Ie(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.xo.get(d), [ 4 /*yield*/ , ya(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , yo(n.localStore, u) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , fo(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Js(n, ba(v), u, 
                /*current=*/ !1) ];
...
function Ia(t) {
    var e = z(t);
    return z(z(e.localStore).persistence).pn();
}
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                M("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                if (!n.ko.has(e)) return [ 3 /*break*/ , 8 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 2 ];
              ...
              case 2:
                return [ 4 /*yield*/ , vo(n.localStore) ];

              case 3:
                return s = r.sent(), a = An.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , la(n, s, a) ];
              ...
              case 6:
                return r.sent(), aa(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Ea(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, a, u, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = Sa(t)).qo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (a = s[o], n.ko.has(a) ? (
                // A target might have been added in a previous attempt
                M("SyncEngine", "Adding an already active target " + a), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , yo(n.localStore, a) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return u = p.sent(), [ 4 /*yield*/ , fo(n.localStore, u) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Js(n, ba(u), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), rs(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.ko.has(t) ? [ 4 /*yield*/ , lo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                is(n.remoteStore, t), aa(n, t);
                            })).catch(Li) ] : [ 3 /*break*/ , 2 ];
...
function Sa(t) {
    var e = z(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Zs.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = pa.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ea.bind(null, e), e.No.Tr = Ps.bind(null, e.eventManager), 
    e.No.jo = Fs.bind(null, e.eventManager), e;
}

function Na(t) {
    var e = z(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = na.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ra.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Ks(n)), o = new Bs(n, t.localStore, e.N), [ 4 /*yield*/ , e.Qo() ];

                  case 5:
                    s = r.sent(), r.label = 6;

                  case 6:
                    return s ? [ 4 /*yield*/ , o.fo(s) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (a = r.sent()) && i._updateProgress(a), [ 4 /*yield*/ , e.Qo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = r.sent(), [ 4 /*yield*/ , la(t, u.Tn, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return q("SyncEngine", "Loading bundle failed with " + (c = r.sent())), i._failWith(c), 
                    [ 3 /*break*/ , 15 ];
...
var Da = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.N = Ho(t.databaseInfo.databaseId), this.sharedClientState = this.Wo(t), 
                    this.persistence = this.Go(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.gcScheduler = this.zo(t), this.localStore = this.Ho(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return io(this.persistence, new no, t.initialUser, this.N);
    }, t.prototype.Go = function(t) {
        return new Do(ko.Ns, this.N);
    }, t.prototype.Wo = function(t) {
        return new qo;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , mo(this.localStore) ];

                  case 2:
                    return r.sent(), [ 4 /*yield*/ , this.Jo.initialize(this, t) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , Na(this.Jo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , vs(this.Jo.remoteStore) ];

                  case 5:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return r.sent(), [ 4 /*yield*/ , this.persistence.nn((function() {
        ...
        var e = $i(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? wi.withCacheSize(this.cacheSizeBytes) : wi.DEFAULT;
        return new Yi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Go(), Qo(), this.N, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Wo = function(t) {
        return new qo;
    }, i;
}(Da), ka = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Jo.syncEngine, this.sharedClientState instanceof Vo ? (this.sharedClientState.syncEngine = {
                        _i: ma.bind(null, i),
                        mi: Ta.bind(null, i),
                        gi: Ea.bind(null, i),
                        pn: Ia.bind(null, i),
                  ...
                  case 3:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return [ 4 /*yield*/ , this.persistence.nn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , ga(this.Jo.syncEngine, t) ];
        ...
        var e = Go();
        if (!Vo.bt(e)) throw new Q(G.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = $i(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Vo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Aa), Ca = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return ta(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = da.bind(null, this.syncEngine), 
        ...
        var e, n = Ho(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new zo(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return ta(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Bo.bt() ? new Bo : new Uo, new ts(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var a = new Ws(t, e, n, r, i, o);
            return s && (a.qo = !0), a;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = z(t), M("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , ns(e) ];

                      case 1:
                        return n.sent(), e.Qr.shutdown(), 
                        // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                        // triggering spurious listener events with cached data, etc.
                        e.Wr.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                    }
                }));
            }));
        }(this.remoteStore);
 ...
 */ var La = /** @class */ function() {
            ...
            return r(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.ea()) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.ea = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.na() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.ta.decode(t), 
                    n = Number(e), isNaN(n) && this.sa("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.ia(n) ]);
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.ra = function() {
    ...
    t.prototype.na = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ra() < 0 ? [ 4 /*yield*/ , this.oa() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.ra()) < 0 && this.sa("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.ia = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.oa() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.sa("Reached the end of bundle when more is expected."), n.label = 2;
                  ...
                  case 3:
                    ...
                    return e = this.ta.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
    ...
    return t.prototype.lookup = function(t) {
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = z(t), i = Jn(n.N) + "/documents", o = {
                                        documents: e.map((function(t) {
                                            return Qn(n.N, t);
                                        }))
                                    }, [ 4 /*yield*/ , n.Ki("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = r.sent(), a = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Hn(t, e.found.name), r = jn(e.found.updateTime), i = new jt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Gt.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                K(!!e.missing), K(!!e.readTime);
                                                var n = Hn(t, e.missing), r = jn(e.readTime);
        ...
        this.write(new un(t, this.precondition(t))), this.writtenDocs.add(t.toString());
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = At.fromPath(n);
                        e.mutations.push(new cn(r, e.precondition(r)));
    ...
    function t(t, e, n, r) {
        ...
        this.aa = 5, this.rr = new Wo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.rr.Xi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Oa(this.datastore), (e = this.ua(t)) && e.then((function(e) {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = L.UNAUTHENTICATED, 
        this.clientId = nt.I(), this.credentialListener = function() {
            return Promise.resolve();
        }, this.credentials.start(e, (function(t) {
            return n(o, void 0, void 0, (function() {
                return r(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return M("FirestoreClient", "Received user=", t.uid), [ 4 /*yield*/ , this.credentialListener(t) ];
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 4:
                        ...
                        // tokens.
                        return this.credentials.shutdown(), e.resolve(), [ 3 /*break*/ , 6 ];

                      case 5:
                        return t = r.sent(), n = Ds(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return a.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , oo(e.localStore, t) ];
...
function Va(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , qa(t) ];

              case 1:
                return i = s.sent(), M("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                    ...
                    return function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return (n = z(t)).asyncQueue.verifyOperationInProgress(), M("RemoteStore", "RemoteStore received new credentials"), 
                                    i = cs(n), 
                                    // Tear down and re-create our network streams. This will ensure we get a
                                    // fresh auth token for the new user and re-fill the write pipeline with
                                    // new mutations from the LocalStore (since mutations are per-user).
                                    n.Kr.add(3 /* CredentialChange */), [ 4 /*yield*/ , ns(n) ];

                                  case 1:
                                    return r.sent(), i && 
                                    // Don't set the network status to Unknown if we are offline.
                                    n.Wr.set("Unknown" /* Unknown */), [ 4 /*yield*/ , n.remoteSyncer.handleCredentialChange(e) ];

                                  case 2:
                                    return r.sent(), n.Kr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , es(n) ];
...
function qa(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.offlineComponents ? [ 3 /*break*/ , 2 ] : (M("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , Ma(t, new Da) ]);
...
function Ua(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.onlineComponents ? [ 3 /*break*/ , 2 ] : (M("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , Va(t, new Ca) ]);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Ys.bind(null, e.syncEngine), 
...
/** Enables the network connection and re-enqueues all pending operations. */ function Qa(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new H;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new La({
                            next: function(o) {
                                ...
                                i.reject(new Q(G.UNAVAILABLE, "Failed to get document because the client is offline.")) : a && o.fromCache && r && "server" === r.source ? i.reject(new Q(G.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), s = new Vs(pe(n.path), o, {
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new La({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return Os(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new Q(G.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
 ...
 * @internal
 */ function $a(t, e, n, r) {
    if (!0 === e && !0 === r) throw new Q(G.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Za(t) {
    if (!At.isDocumentKey(t)) throw new Q(G.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function tu(t) {
    if (At.isDocumentKey(t)) throw new Q(G.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function eu(t) {
 ...
 */ var iu = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new iu({}), 
        this._settingsFrozen = !1, t instanceof Ya ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new Ya(t.options.projectId);
        }(t));
    }
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new iu(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new Y;
            switch (t.type) {
              case "gapi":
                var e = t.client;
              ...
              default:
                throw new Q(G.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Ja.get(t)) && (M("ComponentProvider", "Removing Datastore"), 
 ...
 */ function su(t, e, n, r) {
    var i;
    void 0 === r && (r = {});
    var o = (t = nu(t, ou))._getSettings();
    if ("firestore.googleapis.com" !== o.host && o.host !== e && q("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, o), {
        host: e + ":" + n,
        ssl: !1
    })), r.mockUserToken) {
        var s, a;
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, a = L.MOCK_USER; else {
            ...
            if (!u) throw new Q(G.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            a = new L(u);
        }
        t._credentials = new J(new W(s, a));
    }
}
 ...
 */ var au = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new cu(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, pe(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function hu(t, n) {
    ...
    if (t = b(t), Xa("collection", "path", n), t instanceof ou) {
        var o = lt.fromString.apply(lt, e([ n ], r));
        return tu(o), new cu(t, /* converter= */ null, o);
    }
    if (!(t instanceof au || t instanceof cu)) throw new Q(G.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(lt.fromString.apply(lt, e([ n ], r)));
    return tu(s), new cu(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function fu(t, e) {
    if (t = nu(t, ou), Xa("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Q(G.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new uu(t, 
    /* converter= */ null, 
    /**
...
function lu(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = nt.I()), Xa("doc", "path", n), t instanceof ou) {
        var o = lt.fromString.apply(lt, e([ n ], r));
        return Za(o), new au(t, 
        /* converter= */ null, new At(o));
    }
    if (!(t instanceof au || t instanceof cu)) throw new Q(G.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(lt.fromString.apply(lt, e([ n ], r)));
    return Za(s), new au(t.firestore, t instanceof cu ? t.converter : null, new At(s));
}
 ...
 * Firestore database.
 */ function du(t, e) {
    return t = b(t), e = b(e), (t instanceof au || t instanceof cu) && (e instanceof au || e instanceof cu) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function pu(t, e) {
    return t = b(t), e = b(e), t instanceof uu && e instanceof uu && t.firestore === e.firestore && Ee(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var yu = /** @class */ function() {
    function t() {
        ...
        this.rr = new Wo(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ea = function() {
            var e = Qo();
            e && M("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.rr.tr();
        };
        var e = Qo();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Ea);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Ia((function() {
            return e.wa && e.ya ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Aa = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.da.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.da[0]() ];

                  case 2:
                    return n.sent(), this.da.shift(), this.rr.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.fa.then((function() {
            return e.ga = !0, t().catch((function(t) {
                // Re-throw the error so that this.tail becomes a rejected Promise and
                // all further attempts to chain (via .then) will just short-circuit
                // and return the rejected Promise.
                throw e.ma = t, e.ga = !1, V("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.Pa = function(t) {
        for (var e = 0, n = this._a; e < n.length; e++) {
    ...
    t.prototype.va = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e._a.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e._a; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Ra = function(t) {
...
var mu = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new H, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
    ...
    function n(t, n) {
        ...
        /**
             ...
             */
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new yu, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
    return t(n, e), n.prototype._terminate = function() {
        ...
        Eu(this), this._firestoreClient.terminate();
    }, n;
}(ou);
 ...
 * @internal
 */ function Tu(t) {
    return t._firestoreClient || Eu(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function Eu(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Wa(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Fa(t._credentials, t._queue, r);
}
 ...
 */ function Su(t, e) {
    Ou(t = nu(t, wu));
    var n = Tu(t), r = t._freezeSettings(), i = new Ca;
    return _u(n, i, new Aa(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Nu(t) {
    Ou(t = nu(t, wu));
    var e = Tu(t), n = t._freezeSettings(), r = new Ca;
    return _u(e, r, new ka(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Ma(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Va(t, e) ];
         ...
         */
                    function(t) {
                        return "FirebaseError" === t.name ? t.code === G.FAILED_PRECONDITION || t.code === G.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || (22 === t.code || 20 === t.code || 
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Br.bt() ? (e = t + "main", [ 4 /*yield*/ , Br.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }($i(t._databaseId, t._persistenceKey)) ];
 ...
 */ function ku(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , ja(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = z(t);
                            return e.Kr.delete(0 /* UserDisabled */), es(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Tu(t = nu(t, wu)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = z(t)).Kr.add(0 /* UserDisabled */), [ 4 /*yield*/ , ns(e) ];

                                      case 1:
                                        return n.sent(), 
                                        // Set the OnlineState to Offline so get()s return from cache, etc.
                                        e.Wr.set("Offline" /* Offline */), [ 2 /*return*/ ];
                                    }
                                }));
                            }));
                        }(i)) ];
...
function Lu(t, e) {
    var i = Tu(t = nu(t, wu)), o = new mu;
    return function(t, e, i, o) {
        var s = this, a = function(t, e) {
            return function(t, e) {
                return new Ra(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return xa(t, e);
                if (t instanceof ArrayBuffer) return xa(new Uint8Array(t), e);
...
function Ru(t, e) {
    ...
    }(Tu(t = nu(t, wu)), e).then((function(e) {
        return e ? new uu(t, null, e.query) : null;
    }));
}
 ...
 */ var Pu = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new Q(G.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this._internalPath = new pt(t);
    }
    /**
 ...
 */ var Mu = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(mt.fromBase64String(e));
        } catch (e) {
            throw new Q(G.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(mt.fromUint8Array(e));
    }, 
    /**
...
/** A "context" object passed around while parsing user data. */ var zu = /** @class */ function() {
    /**
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Sa(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    return Object.defineProperty(t.prototype, "path", {
        ...
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "Da", {
        get: function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Ca = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Ca({
            path: n,
            xa: !1
        });
        return r.ka(t), r;
        ...
        return hc(t, this.settings.methodName, this.settings.Ma || !1, this.path, this.settings.La);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.ka(this.path.get(t));
    }, t.prototype.ka = function(t) {
        if (0 === t.length) throw this.Fa("Document fields must not be empty");
        if (ju(this.Da) && Uu.test(t)) throw this.Fa('Document fields cannot begin and end with "__"');
    }, t;
}(), Gu = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.N = n || Ho(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.Ba = function(t, e, n, r) {
        return void 0 === r && (r = !1), new zu({
            Da: t,
            methodName: e,
            La: n,
            path: pt.emptyPath(),
 ...
 * classes.
 */ function Qu(t) {
    var e = t._freezeSettings(), n = Ho(t._databaseId);
    return new Gu(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Hu(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Ba(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    sc("Data must be an object, but it was:", s, r);
    var a, u, c = ic(r, s);
    if (o.merge) a = new yt(s.fieldMask), u = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = ac(e, l[f], n);
            if (!s.contains(d)) throw new Q(G.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            fc(h, d) || h.push(d);
        }
        a = new yt(h), u = s.fieldTransforms.filter((function(t) {
            return a.covers(t.field);
        }));
    } else a = null, u = s.fieldTransforms;
    return new Bu(new jt(c), a, u);
}
...
var Ju = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new ze(t.path, new Fe);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Vu), Xu = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Ua = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = Yu(this, t, 
        /*array=*/ !0), n = this.Ua.map((function(t) {
            return rc(t, e);
        })), r = new Me(n);
...
}(Vu), Zu = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).qa = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Be(t.N, xe(t.N, this.qa));
...
/** Parse update data from an update() call. */ function tc(t, e, n, r) {
    var i = t.Ba(1 /* Update */ , e, n);
    sc("Data must be an object, but it was:", i, r);
    var o = [], s = jt.empty();
    ct(r, (function(t, r) {
        var a = cc(e, t, n);
    ...
    var a = new yt(o);
    return new Ku(s, a, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function ec(t, e, n, r, i, o) {
    var s = t.Ba(1 /* Update */ , e, n), a = [ ac(e, r, n) ], u = [ i ];
    if (o.length % 2 != 0) throw new Q(G.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) a.push(ac(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = jt.empty(), l = a.length - 1; l >= 0; --l) if (!fc(h, a[l])) {
        var d = a[l], p = u[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = b(p);
    ...
    var m = new yt(h);
    return new Ku(f, m, s.fieldTransforms);
}
 ...
 */ function nc(t, e, n, r) {
    return void 0 === r && (r = !1), rc(n, t.Ba(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function rc(t, e) {
    ...
    // from firestore-exp.
    t = b(t))) return sc("Unsupported field value:", e, t), ic(t, e);
    if (t instanceof Vu) 
    ...
    return function(t, e) {
        ...
        if (!ju(e.Da)) throw e.Fa(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return xe(e.N, t);
        ...
        if (t instanceof Mu) return {
            bytesValue: Bn(e.N, t._byteString)
        };
        if (t instanceof au) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.Fa("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: zn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Fa("Unsupported field value: " + eu(t));
    }(t, e);
}
...
function ic(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : ct(t, (function(t, r) {
        var i = rc(r, e.Na(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function oc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof st || t instanceof qu || t instanceof Mu || t instanceof au || t instanceof Vu);
}
...
function sc(t, e, n) {
    if (!oc(n) || !function(t) {
        ...
        var r = eu(n);
        throw "an object" === r ? e.Fa(t + " a custom object") : e.Fa(t + " " + r);
    }
}
 ...
 */ function ac(t, e, n) {
    ...
    // FieldPath.
    (e = b(e)) instanceof Pu) return e._internalPath;
    if ("string" == typeof e) return cc(t, e);
    throw hc("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function cc(t, n, r) {
    if (n.search(uc) >= 0) throw hc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Pu.bind.apply(Pu, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw hc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
 ...
 */ var lc = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new dc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(pc("DocumentSnapshot.get", t));
 ...
 */
function pc(t, e) {
    return "string" == typeof e ? cc(t, e) : e instanceof Pu ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var yc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new mc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(pc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(lc), mc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(vc), gc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new yc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new mc(n._firestore, n._userDataWriter, r.key, r, new yc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new mc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new yc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new mc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new yc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function Ic(t) {
    if (ve(t) && 0 === t.explicitOrderBy.length) throw new Q(G.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Sc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Ka = t, i.ja = n, i.Qa = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Qu(t.firestore), n = function(t, e, n, r, i, o, s) {
            var a;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new Q(G.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
 ...
 */
                ...
                throw i === e.op ? new Q(G.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new Q(G.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t._query, 0, e, t.firestore._databaseId, this.Ka, this.ja, this.Qa);
        return new uu(t.firestore, t.converter, function(t, e) {
...
var _c = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Ka = t, r.Wa = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var Ac = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Ga = n, i.za = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new uu(t.firestore, t.converter, Te(t._query, this.Ga, this.za));
    }, n;
}(Tc);
 ...
 * @returns The created {@link Query}.
 */ function kc(t) {
    return ru("limit", t), new Ac("limit", t, "F" /* First */)
    /**
...
function Cc(t) {
    return ru("limitToLast", t), new Ac("limitToLast", t, "L" /* Last */);
}

var xc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Ha = n, i.Ja = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Mc(t, this.type, this.Ha, this.Ja);
        return new uu(t.firestore, t.converter, function(t, e) {
...
function Lc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new xc("startAt", t, /*before=*/ !0);
}

function Rc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new xc("startAfter", t, 
    /*before=*/ !1);
}
...
function Pc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Oc("endBefore", t, /*before=*/ !0);
}

function Fc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Oc("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Mc(t, e, n, r) {
    if (n[0] = b(n[0]), n[0] instanceof lc) return function(t, e, n, r, i) {
        if (!r) throw new Q(G.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], s = 0, a = be(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(Ft(e, r.key)); else {
                var c = r.data.field(u.field);
                if (Tt(c)) throw new Q(G.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = u.field.canonicalString();
                    throw new Q(G.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Qu(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new Q(G.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var a = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (s[u].field.isKeyField()) {
                if ("string" != typeof c) throw new Q(G.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!we(t) && -1 !== c.indexOf("/")) throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(lt.fromString(c));
                if (!At.isDocumentKey(h)) throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new At(h);
                a.push(Ft(e, f));
            } else {
                var l = nc(n, r, c);
...
function Vc(t, e, n) {
    if ("string" == typeof (n = b(n))) {
        if ("" === n) throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!we(e) && -1 !== n.indexOf("/")) throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(lt.fromString(n));
        if (!At.isDocumentKey(r)) throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Ft(t, new At(r));
    }
    if (n instanceof au) return Ft(t, n._key);
    throw new Q(G.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + eu(n) + ".");
}
 ...
 */ var Bc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return ct(t.fields, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new qu(bt(t.latitude), bt(t.longitude));
        ...
        K(yr(n));
        var r = new Ya(n.get(1), n.get(3)), i = new At(n.popFirst(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        V("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}();
...
var jc = /** @class */ function(e) {
...
}(Bc), zc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Qu(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Gc(t, this._firestore), i = Kc(r.converter, e, n), o = Hu(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Qe.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Gc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Pu ? ec(this._dataReader, "WriteBatch.update", s._key, e, n, r) : tc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Qe.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Gc(t, this._firestore);
        return this._mutations = this._mutations.concat(new un(e._key, Qe.none())), this;
    }, 
    /**
 ...
 * called.
 */ function Gc(t, e) {
    if ((t = b(t)).firestore !== e) throw new Q(G.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Qc(t) {
    t = nu(t, au);
    var e = nu(t.firestore, wu);
    return Qa(Tu(e), t._key).then((function(n) {
        return sh(e, t, n);
    }));
}
 ...
 */ function Wc(t) {
    t = nu(t, au);
    var e = nu(t.firestore, wu), i = Tu(e), o = new Hc(e);
    return function(t, e) {
        var i = this, o = new H;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new Q(G.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = Ds(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new vc(e, o, t._key, n, new yc(null !== n && n.hasLocalMutations, 
 ...
 */ function Jc(t) {
    t = nu(t, uu);
    var e = nu(t.firestore, wu), n = Tu(e), r = new Hc(e);
    return Ic(t._query), Ha(n, t._query).then((function(n) {
        return new gc(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , po(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Gs(e, n.Gn), s = o.Io(n.documents), a = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(a.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return u = r.sent(), c = Ds(u, "Failed to execute query '" + e + " against cache"), 
...
function Zc(t, e, n) {
    t = nu(t, au);
    var r = nu(t.firestore, wu), i = Kc(t.converter, e, n);
    return oh(r, [ Hu(Qu(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Qe.none()) ]);
}

function th(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = nu(t, au);
    var o = nu(t.firestore, wu), s = Qu(o);
    return oh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = b(e)) || e instanceof Pu ? ec(s, "updateDoc", t._key, e, n, r) : tc(s, "updateDoc", t._key, e)).toMutation(t._key, Qe.exists(!0)) ]);
}
 ...
 */ function eh(t) {
    return oh(nu(t.firestore, wu), [ new un(t._key, Qe.none()) ]);
}
 ...
 */ function nh(t, e) {
    var n = nu(t.firestore, wu), r = lu(t), i = Kc(t.converter, e);
    return oh(n, [ Hu(Qu(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Qe.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function rh(t) {
    ...
    "object" != typeof s[c] || vu(s[c]) || (u = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof au) f = nu(t.firestore, wu), l = pe(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](sh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = nu(t, uu);
        f = nu(y.firestore, wu), l = y._query;
        var v = new Hc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new gc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, Ic(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, a = new La(o), u = new Vs(e, a, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            a.Xo(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Os, [ 4 /*yield*/ , Ga(t) ];
 ...
 */ function sh(t, e, n) {
    var r = n.docs.get(e._key), i = new Hc(t);
    return new vc(t, i, e._key, r, new yc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var ah = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Gc(t, this._firestore), i = new Hc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new vc(n._firestore, i, r._key, t._document, new yc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Qu(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Gc(t, this._firestore), r = new jc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return B();
            var i = t[0];
            if (i.isFoundDocument()) return new lc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new lc(e._firestore, r, n._key, null, n.converter);
            throw B();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Gc(t, this._firestore), i = Kc(r.converter, e, n), o = Hu(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Pu ? ec(this._dataReader, "Transaction.update", s._key, e, n, r) : tc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Pa(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
 ...
 * writes.
 */ function ph(t) {
    return Tu(t = nu(t, wu)), new zc(t, (function(e) {
        return oh(t, e);
    }))
    /**
 * Cloud Firestore
...
R = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new wu(r, new X(t.getProvider("auth-internal")));
    return n = Object.assign({
        useFetchStreams: !0
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), s("@firebase/firestore", "3.0.3-202181503543", undefined);
