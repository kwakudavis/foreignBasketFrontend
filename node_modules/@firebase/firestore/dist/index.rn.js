...
/** Extracts the backend's type order for the provided value. */ function vt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Et(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : M();
}
...
function Dt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = tt(yt(t.latitude), yt(e.latitude));
            if (0 !== n) return n;
            return tt(yt(t.longitude), yt(e.longitude));
...
function Ct(t, e) {
    ...
    const n = gt(t), s = gt(e), i = tt(n.seconds, s.seconds);
...
/** Creates a deep copy of `source`. */ function Bt(t) {
    ...
    if (t.mapValue) {
        ...
        return ot(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Bt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class Kt {
     ...
     */    static newInvalidDocument(t) {
        return new Kt(t, 0 /* INVALID */ , it.min(), Ut.empty(), 0 /* SYNCED */);
    }
    /**
 ...
 */ function Te(t) {
    const e = U(t);
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Qt(e.path, e.collectionGroup, Ee(e), e.filters, e.limit, e.startAt, e.endAt); else {
...
function Ae(t, e) {
    return zt(Te(t), Te(e)) && t.limitType === e.limitType;
}
...
function Re(t) {
    return `${Wt(Te(t))}|lt:${t.limitType}`;
}

function be(t) {
    return `Query(target=${Gt(Te(t))}; limitType=${t.limitType})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !he(t.startAt, Ee(t), e)) return !1;
        if (t.endAt && he(t.endAt, Ee(t), e)) return !1;
        return !0;
    }
    /**
...
function Qe(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Fe && e instanceof Fe || t instanceof Le && e instanceof Le ? et(t.elements, e.elements, Vt) : t instanceof Ue && e instanceof Ue ? Vt(t.C, e.C) : t instanceof Oe && e instanceof Oe;
...
function Ze(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && et(t, e, ((t, e) => Qe(t, e)));
 ...
 */ class Sn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, Dn.createSynthesizedTargetChangeForCurrentChange(t, e)), new Sn(it.min(), n, Vn(), En(), Pn());
    }
}
...
class $n {
     ...
     */    _t(t) {
        ...
        return this.nt = En(), this.st = On(), this.it = new gn(tt), s;
    }
    /**
    ...
    yt(t) {
        let e = this.st.get(t);
        return e || (e = new gn(tt), this.st = this.st.insert(t, e)), e;
    }
    /**
...
function Jn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? ut.emptyPath() : Xn(e);
}
...
function is(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        let n = null;
        if ("setToServerValue" in e) L("REQUEST_TIME" === e.setToServerValue), n = new Oe; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Fe(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Le(t);
        } else "increment" in e ? n = new Ue(t, e.increment) : M();
...
function hs(t) {
    return t ? void 0 !== t.unaryFilter ? [ ys(t) ] : void 0 !== t.fieldFilter ? [ gs(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => hs(t))).reduce(((t, e) => t.concat(e))) : M() : [];
}
 ...
 */ class js {
    ...
    next(t, e) {
        return this.callbackAttached && M(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new js(((n, s) => {
            this.nextCallback = e => {
...
class Qs {
    constructor(t, e) {
         ...
         */
        this.Tt = new j, this.transaction.oncomplete = () => {
            this.Tt.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.Tt.reject(new zs(t, e.error)) : this.Tt.resolve();
        }, this.transaction.onerror = e => {
            const n = Zs(e.target.error);
            this.Tt.reject(new zs(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
    ...
    abort(t) {
        t && this.Tt.reject(t), this.aborted || (k("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Ws {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ws.Rt(u()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return k("SimpleDb", "Removing database:", t), Ys(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static bt() {
        ...
        // Check the UA string to find out the browser.
                const t = u(), e = Ws.Rt(t), n = 0 < e && e < 10, s = Ws.vt(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async Dt(t) {
        return this.db || (k("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new K(q.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new K(q.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new zs(t, s));
            }, s.onupgradeneeded = t => {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class zs extends K {
    constructor(t, e) {
 ...
 */ class ni {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && et(this.mutations, t.mutations, ((t, e) => Ze(t, e))) && et(this.baseMutations, t.baseMutations, ((t, e) => Ze(t, e)));
    }
}
...
function fi(t, e) {
    ...
    const s = e.mutations.map((e => is(t.Wt, e))), i = st.fromMillis(e.localWriteTimeMs);
    return new ni(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function di(t) {
    const e = li(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? li(t.lastLimboFreeSnapshotVersion) : it.min();
    let s;
    var i;
 ...
 */ class Ei {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new gn(ut.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new gn(ut.comparator)).toArray();
    }
}
...
class vi {
    ...
    lookupMutationBatch(t, e) {
        return Si(t).get(e).next((t => t ? (L(t.userId === this.userId), fi(this.N, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Si(t).Kt({
            ...
            e.userId === this.userId && (L(e.batchId >= n), i = fi(this.N, e)), s.done();
        })).next((() => i));
    }
    ...
    Zt(t, e) {
        ...
        return e.forEach((e => {
            s.push(Si(t).get(e).next((t => {
                if (null === t) throw M();
                L(t.userId === this.userId), n.push(fi(this.N, t));
            })));
        })), js.waitFor(s).next((() => n));
    }
 ...
 */ class xi {
    ...
    re(t) {
        return $i(t).get(Os.key).next((t => (L(null !== t), t)));
    }
    oe(t, e) {
 ...
 */ async function Fi(t) {
    if (t.code !== q.FAILED_PRECONDITION || t.message !== qs) throw t;
    ...
    _e(t) {
        ...
        k("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Hs(t) ? k("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Fi(t);
            }
            await this._e(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ui {
    ...
    collect(t, e) {
        ...
        js.resolve(Ai)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (k("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Ai) : this.pe(t, e)));
    }
    getCacheSize(t) {
        ...
        return this.Te(t, ((r, o) => {
            if (o <= e) {
                const e = this.Ie(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), Oi(t).delete([ 0, Ts(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Wi {
     ...
     */    ve(t, e) {
        let n = En(), s = new wn(Pt.comparator);
        return this.Pe(t, e, ((t, e) => {
            const i = this.Re(t, e);
    ...
    getMetadata(t) {
        return zi(t).get(xs.key).next((t => (L(!!t), t)));
    }
    Ae(t, e) {
...
class Gi extends Qi {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new gn(((t, e) => tt(t.canonicalString(), e.canonicalString())));
     ...
     */    xe(t) {
        ...
        return t.store(Os.store).get(Os.key).next((t => {
            ...
            return n.Kt(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? js.resolve() : (n => e.put(new $s(0, Ts(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => js.waitFor(s)));
        }));
    }
    ke(t, e) {
        ...
        const n = e.store(Fs.store), s = new Ei, i = t => {
            if (s.add(t)) {
 ...
 */
     ...
     */    start() {
        ...
        return this.Xe().then((() => {
            ...
            throw new K(q.FAILED_PRECONDITION, Zi);
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Ge.runTransaction(t, s, Us, (s => (i = new ti(s, this.Le ? this.Le.next() : Y.T), 
     ...
     */    tn() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Ue = () => {
            ...
            this._n(), h() && navigator.appVersion.match("Version/14") && 
...
async function Ir(t, e, n, s) {
    ...
    const a = i.jn.newChangeBuffer({
        ...
        return Te(we(ut.fromString(`__bundle__/docs/${t}`)));
    }(s));
...
async function Ar(t, e, n = Pn()) {
    ...
    const s = await mr(t, Te(_i(e.bundledQuery))), i = U(t);
 ...
 */ class Dr {
    ...
    forEachTarget(t, e) {
        return this.Ts.forEach(((t, n) => e(n))), js.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
...
class Fr {
     ...
     */    static $s(t, e, n) {
        ...
        r && (i = new K(s.error.code, s.error.message))), r ? new Fr(t, e, s.state, i) : ($("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Os() {
        const t = {
...
class Mr {
     ...
     */    static $s(t, e) {
        ...
        i && (s = new K(n.error.code, n.error.message))), i ? new Mr(t, n.state, s) : ($("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Os() {
        const t = {
 ...
 */ class Lr {
     ...
     */    static $s(t, e) {
        ...
        return s ? new Lr(t, i) : ($("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Br {
     ...
     */    static $s(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Br(e.clientId, e.onlineState) : ($("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class qr {
    constructor(t, e, n, s, i) {
        ...
        this.qs = new wn(tt), this.started = !1, 
        /**
...
class {
    ...
    ji(t, e) {
        const n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = A(), i = R(), r = {
        ...
        this.useFetchStreams && (r.xmlHttpFactory = new b({})), this.Ui(r.initMessageHeaders, e), 
 ...
 */
            ...
            t.stat === V.PROXY ? k("Connection", "Detected buffering proxy") : t.stat === V.NOPROXY && k("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
 ...
 */ class to extends Zr {
    ...
    onMessage(t) {
        ...
        const e = ns(this.N, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? it.min() : e.readTime ? jn(e.readTime) : it.min();
        }(t);
    ...
    e, n, s, i) {
        ...
        this.jr = [], this.Qr = i, this.Qr.Ei((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                wo(this) && (k("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */
        ...
        k("RemoteStore", "Failed to raise snapshot:", e), await po(t, e);
    }
}
...
async function Vo(t, e, n) {
    ...
    await Eo(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
...
async function So(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, fn(n) && n !== q.ABORTED) {
            ...
            // restart.
                        No(t).hr(), await Eo(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
 ...
 */ function ko(t, e) {
    if ($("AsyncQueue", `${e}: ${t}`), Hs(t)) return new K(q.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Xo {
    ...
    e) {
        ...
        this.mutatedKeys = Pn(), this.po = ve(t), this.Eo = new $o(this.po);
    }
    /**
     ...
     */    Io(t, e) {
        const n = e ? e.Ao : new Oo, s = e ? e.Eo : this.Eo;
 ...
 */ (t.type, e.type) || this.po(t.doc, e.doc))), this.bo(n);
    ...
    // PORTING NOTE: Multi-tab only.
    Do() {
        return Fo.fromInitialDocuments(this.query, this.Eo, this.mutatedKeys, 0 /* Local */ === this.mo);
    }
}
 ...
 */ async function ac(t, e, n) {
    ...
    if (r) {
        ...
        t = t.insert(r, Kt.newNoDocument(r, it.min()));
 ...
 */ class Oc extends $c {
    ...
    Wo(t) {
        const e = Hr();
        if (!qr.bt(e)) throw new K(q.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Fc {
    ...
    terminate() {
        return async function(t) {
            const e = U(t);
            k("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5 /* Shutdown */), await oo(e), 
            e.Qr.shutdown(), 
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Lc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Uo(t, o))), n.fromCache && "server" === s.source ? i.reject(new K(q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Qo(n, r, {
            includeMetadataChanges: !0,
...
function Ta(t, e, n, s = {}) {
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = S.MOCK_USER; else {
            ...
            e = g(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
 ...
 * limitations under the License.
 */ function Ou(t) {
    if (me(t) && 0 === t.explicitOrderBy.length) throw new K(q.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
/** Helper function to create a bound from a document or fields */ function Xu(t, e, n, s) {
    if (n[0] = y(n[0]), n[0] instanceof vu) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Ee(t)) if (n.field.isKeyField()) r.push(kt(e, s.key)); else {
            const t = s.data.field(n.field);
            if (Et(t)) throw new K(q.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
...
function Zu(t, e, n) {
    if ("string" == typeof (n = y(n))) {
        ...
        if (!pe(e) && -1 !== n.indexOf("/")) throw new K(q.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
...
function oh(t, e) {
    if ((t = y(t)).firestore !== e) throw new K(q.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
}), "PUBLIC" /* PUBLIC */)), s("@firebase/firestore", "3.0.3-202181503543", Dh);
