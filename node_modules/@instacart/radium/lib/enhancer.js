...
var _resolveStyles2 = _interopRequireDefault(require("./resolve-styles"));
...
var ReactForwardRefSymbol = /*#__PURE__*/(0, _react.forwardRef)(function () {
  return null;
}).$$typeof;
var ReactMemoSymbol = /*#__PURE__*/(0, _react.memo)(function () {
  return null;
}).$$typeof;
...
function renderRadiumComponent(enhancer, renderedElement, resolvedConfig, propConfig) {
  ...
  if (propConfig) {
    return /*#__PURE__*/_react["default"].createElement(_context.RadiumConfigContext.Provider, {
      value: propConfig
    }, element);
  }
...
function createEnhancedFunctionComponent(origComponent, config) {
  ...
  var RadiumEnhancer = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  ...
  if (isMemo(origComponent)) {
    RadiumEnhancer = /*#__PURE__*/(0, _react.memo)(RadiumEnhancer);
