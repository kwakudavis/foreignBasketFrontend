...
var _resolveChildren = function _resolveChildren(_ref) {
  ...
  if (childrenType === 'function') {
    ...
    return function () {
      ...
      if ( /*#__PURE__*/_react["default"].isValidElement(result)) {
...
var _runPlugins = function _runPlugins(_ref4) {
  ...
  // no style.
  if (! /*#__PURE__*/_react["default"].isValidElement(renderedElement) || typeof renderedElement.type !== 'string' || !props.style) {
    return props;
  }
...
var _cloneElement = function _cloneElement(renderedElement, newProps, newChildren) {
  ...
  return /*#__PURE__*/_react["default"].cloneElement(renderedElement, newProps, newChildren);
}; //
