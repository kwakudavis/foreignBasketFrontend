...
export function renderFcIntoDocument(element) {
  return TestUtils.renderIntoDocument( /*#__PURE__*/React.createElement(Wrapper, null, element));
}
...
export function createEsClass(renderFn) {
  var Composed = /*#__PURE__*/function (_Component2) {
    _inherits(Composed, _Component2);

    var _super2 = _createSuper(Composed);
    ...
    _createClass(Composed, [{
      key: "render",
      value: function render() {
        return renderFn() || /*#__PURE__*/React.createElement("div", null);
      }
    }]);
